        ...
        <div class="citer">
            <p>
                مع <span class="CompanyName">I-Valley</span> لديك خيارات متعددة
                 لتطوير حلول الانترنت الخاصة 
                بك, نحن لا تركز  
                فقط في تطوير المواقع ولكن أيضا نحن مهتمون
                 في القيام تطوير تطبيقات العمل المكتبى و دورات العمل و جميع حلول قواعد البيانات بالاضافه الى ارشفة الوثائق,
                 برمجة البوابات, حلول نظم ادارات المحتوى واكثر ...    حلول الإنترنت لدينا مقسمة إلى الخدمات التالية:
            </p>
            <div class="large-6 columns webDev" style="padding: 5px; border-right: 2px solid #a82743">
                <h4>
                    تطوير مخصص لحلول الويب </h4>
                <p>
                    <br />
                    نحن نساعدك فى الوصول الى الطريقه المثلى فى ميكنة اعمالك المكتبيه و دورة العمل الخاصه بك من خلال تفصيل جميع احتياجاتك 
                    الخاصه لانهاء اعمالك فى برامج مخصصه لك ... 
                </p>
                <div class="clear-fix">
                </div>
                ...
                <p>
                    فى قسم تطوير مخصص لحلول الويب يمكننا تنفيذ اى فكرة توحي لك من أجل ترقية وتعزيز عملك مثل هذه:
                    </p>
                ...
                <p>
                    ...
                    <div id="buttons">
                        <a class="largeButton" id="requestButton" style="text-align:center;margin-left:120px;width:190px;cursor:pointer;line-height:0px">طلب الخدمه
                        </a>
            ...
            <div class="large-6 columns webDev" style="padding: 5px;">
                ...
                <div id="buttons" style="margin-left:160px;">
                    ...
                    <a class="largeButton" style="width: 275px; line-height: 0px" 
                        href="CMSWizard.aspx">ابدء الموقع الاكترونى الخاص بك </a>
                </div>
            </div>
        </div>
    </div>
