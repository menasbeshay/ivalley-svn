<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="EditOrderStatus.aspx.cs" Inherits="website.Admin.EditOrderStatus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="AdminMain">
        <asp:Panel ID="uiPanelViewStatus" runat="server">
            <div class="ContentLeftDiv">
                ...
                <div class="Details675">
                    ...
                    <div class="AdminMiddle">
                        <div class="AdminMore">
                            <asp:LinkButton ID="uiLinkButtonAdd" runat="server" OnClick="uiLinkButtonAdd_Click">Add new Status</asp:LinkButton>
                        </div>
                    </div>
                    <div class="AdminLeft">
                    </div>
                    ...
                    <div class="AdminMiddle" style="width: 100%">
                        <asp:GridView ID="uiGridViewStatus" runat="server" AutoGenerateColumns="False" OnRowCommand="uiGridViewStatus_RowCommand"
                            AllowPaging="True" OnPageIndexChanging="uiGridViewStatus_PageIndexChanging" EnableModelValidation="True"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Actions">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="uiLinkButtonEdit" runat="server" CommandArgument='<%# Eval("OrderStatusID") %>'
                                            CommandName="EditStatus">Edit</asp:LinkButton>&nbsp;
                                        <asp:LinkButton ID="uiLinkButtonDelete" runat="server" CommandArgument='<%# Eval("OrderStatusID") %>'
                                            CommandName="DeleteStatus" OnClientClick="return confirm('do you want to delete this record ?');">Delete</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
