...
namespace website
{
    public partial class Images : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (Request.QueryString["Inner"] == "product")
                {
                    bmp = FixedSize(Path, 158, 158);
                }
                ...
                else if (Request.QueryString["Inner"] == "Slide")
                {
                    bmp = FixedSize(Path, 110, 110);
                }
                else if (Request.QueryString["Inner"] == "Projects")
                {
                    bmp = FixedSize(Path, 600, 180);
                }
                else
                {
