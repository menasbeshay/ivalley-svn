...
{
	public abstract class _FlightType : SqlClientEntity
	{
		public _FlightType()
		{
			this.QuerySource = "FlightType";
			this.MappingName = "FlightType";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_FlightTypeLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int FlightTypeID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.FlightTypeID, FlightTypeID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_FlightTypeLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[FlightTypeID] = _FlightType.PropertyNames.FlightTypeID;
					ht[Name] = _FlightType.PropertyNames.Name;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[FlightTypeID] = _FlightType.ColumnNames.FlightTypeID;
					ht[Name] = _FlightType.ColumnNames.Name;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FlightTypeInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.FlightTypeID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FlightTypeUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FlightTypeDelete]";
