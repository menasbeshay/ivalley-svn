...
{
	public abstract class _TitleCourse : SqlClientEntity
	{
		public _TitleCourse()
		{
			this.QuerySource = "TitleCourse";
			this.MappingName = "TitleCourse";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_TitleCourseLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int CourseID, int TitleID)
		{
...
parameters.Add(Parameters.TitleID, TitleID);
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_TitleCourseLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[CourseID] = _TitleCourse.PropertyNames.CourseID;
					ht[TitleID] = _TitleCourse.PropertyNames.TitleID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[CourseID] = _TitleCourse.ColumnNames.CourseID;
					ht[TitleID] = _TitleCourse.ColumnNames.TitleID;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TitleCourseInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TitleCourseUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TitleCourseDelete]";
