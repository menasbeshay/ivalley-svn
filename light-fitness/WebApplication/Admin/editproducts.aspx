<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpages/Admin.Master" AutoEventWireup="true" CodeBehind="editproducts.aspx.cs" Inherits="WebApplication.Admin.editproducts" %>
            ...
            <div class="ContentLeftDiv">
                ...
                <div class="AdminDetails728">
                    ...
                    <div class="AdminMiddle" style="width:280px">
                        ...
                        <asp:CheckBox ID="uiCheckBoxOptimize" runat="server" Text="optimize " Visible="false"/>
                    </div>
                    <div class="AdminLeft">
                    ...
                    <div class="AdminMiddle" style="text-align: center">
                        ...
                        <div class="AdminMore" style="width:130px;">
                            <asp:LinkButton ID="uiLinkButtonBack" runat="server" Text="Back to products" OnClick="uiLinkButtonBack_Click" style="width:130px;"></asp:LinkButton></div>
                    </div>
                    <div class="AdminLeft">
                    </div>
                    <div class="clear">
