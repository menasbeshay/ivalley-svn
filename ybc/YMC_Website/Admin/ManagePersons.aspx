<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="ManagePersons.aspx.cs" Inherits="YMC_Website.Admin.ManagePersons" %>
            ...
            <div class="ContentLeftDiv">
                ...
                <div class="Details675">
                    <div class="AdminRight" style="width: 150px">
                        <div class="AdminMore">
                            <asp:LinkButton ID="uiLinkButtonAdd" runat="server" OnClick="uiLinkButtonAdd_Click">إضافة شخص جديد</asp:LinkButton>
                        </div>
                    </div>
        ...
        <asp:Panel ID="uiPanelEdit" runat="server" Visible="false">
            <div class="ContentLeftDiv">
                ...
                <div class="AdminDetails728">
                    ...
                    <div class="AdminMiddle">
                        <asp:TextBox ID="uiTextBoxDetails" runat="server" TextMode="MultiLine" 
