<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="MaangeRequests.aspx.cs" Inherits="YMC_Website.Admin.MaangeRequests" %>
        ...
        <asp:Panel ID="uiPanelEdit" runat="server" Visible="false">
            <div class="ContentLeftDiv">
                ...
                <div class="AdminDetails728">
                    ...
                    <div class="AdminRight">
                        <asp:Label ID="Label1" runat="server" Text=" ملف ملحق : " CssClass="Label"></asp:Label>
                    </div>
                    <div class="AdminMiddle">
                        <asp:HyperLink ID="uiHyperLinkFile" runat="server">تحميل ملف</asp:HyperLink>
                    </div>
                    <div class="AdminLeft">
                    </div>
                    <div class="clear">
                    ...
                    <div class="AdminMiddle" style="width: 95%">
                        <FCKeditorV2:FCKeditor ID="uiFckeditorReply" runat="server" BasePath="~/Modules/fckeditor/"
                            Height="500px">
                        </FCKeditorV2:FCKeditor>
                    </div>
                    <div class="clear">
