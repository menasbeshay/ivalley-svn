	...
	public abstract class _NewsLetter : SqlClientEntity
	{
		...
		protected class Parameters
		{
			...
			public static SqlParameter Email
			{
				get
				{
					return new SqlParameter("@Email", SqlDbType.NVarChar, 250);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _NewsLetter.PropertyNames.ID;
					ht[Email] = _NewsLetter.PropertyNames.Email;
					ht[Description] = _NewsLetter.PropertyNames.Description;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _NewsLetter.ColumnNames.ID;
					ht[Email] = _NewsLetter.ColumnNames.Email;
					ht[Description] = _NewsLetter.ColumnNames.Description;
