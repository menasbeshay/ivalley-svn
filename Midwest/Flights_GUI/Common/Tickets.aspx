            ...
            <div class="Details900">
                ...
                <asp:Panel ID="uiPanelSearch" runat="server" DefaultButton="uiButtonSearch">
                    <div class="AdminMiddle">
                        ...
                        <cc1:CalendarExtender ID="uiTextBoxFromDate_CalendarExtender" runat="server" Enabled="True"
                        ...
                        <cc1:CalendarExtender ID="uiTextBoxToDate_CalendarExtender" runat="server" Enabled="True"
                ...
                <div class="AdminMiddle" 
                    ...
                    <telerik:RadGrid ID="uiRadGrid" runat="server" AutoGenerateColumns="False" 
                        ...
                        <MasterTableView HierarchyDefaultExpanded="false" Width="100%" HierarchyLoadMode="Client"
                            DataKeyNames="SectorID, ReturnSectorID">
                            <SelfHierarchySettings ParentKeyName="SectorID" KeyName="ReturnSectorID" MaximumDepth="1"></SelfHierarchySettings>                                                        
                            <Columns>
                            <telerik:GridBoundColumn DataField="FlightNo" HeaderText="Flight No."></telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="IsReturnSector" HeaderText="IsReturnSector" Visible="false">
                            ...
                            <telerik:GridTemplateColumn HeaderText="Actions">
                                <ItemTemplate>
                                    ...
                                    <asp:linkbutton id="uiLinkButtonDelete" runat="server" commandargument='<%# Eval("SectorID") %>'
                                        commandname="DeleteSector" onclientclick="return confirm('This ticket may have a return one.\r if you delete it , its return ticket will be a normal ticket.\r\n Are you want to delete this record? ');"><img src="../images/delete.png" alt="Delete" title="Delete" style="border:0;float:none;" /></asp:LinkButton>
                                </ItemTemplate>
