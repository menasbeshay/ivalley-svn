...
{
	public abstract class _FlightCrew : SqlClientEntity
	{
		public _FlightCrew()
		{
			this.QuerySource = "FlightCrew";
			this.MappingName = "FlightCrew";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_FlightCrewLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int ReportCrewID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.ReportCrewID, ReportCrewID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_FlightCrewLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter ReportCrewID
			{
				get
				{
					return new SqlParameter("@ReportCrewID", SqlDbType.Int, 0);
				}
			}
		...
		{  
            public const string ReportCrewID = "ReportCrewID";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ReportCrewID] = _FlightCrew.PropertyNames.ReportCrewID;
					ht[ReportID] = _FlightCrew.PropertyNames.ReportID;
					ht[CrewID] = _FlightCrew.PropertyNames.CrewID;
					ht[PositionID] = _FlightCrew.PropertyNames.PositionID;
					ht[Notes] = _FlightCrew.PropertyNames.Notes;
					ht[CreatedBy] = _FlightCrew.PropertyNames.CreatedBy;
					ht[ModifiedBy] = _FlightCrew.PropertyNames.ModifiedBy;
					ht[CreatedDate] = _FlightCrew.PropertyNames.CreatedDate;
					ht[LastModifiedDate] = _FlightCrew.PropertyNames.LastModifiedDate;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ReportCrewID] = _FlightCrew.ColumnNames.ReportCrewID;
					ht[ReportID] = _FlightCrew.ColumnNames.ReportID;
					ht[CrewID] = _FlightCrew.ColumnNames.CrewID;
					ht[PositionID] = _FlightCrew.ColumnNames.PositionID;
					ht[Notes] = _FlightCrew.ColumnNames.Notes;
					ht[CreatedBy] = _FlightCrew.ColumnNames.CreatedBy;
					ht[ModifiedBy] = _FlightCrew.ColumnNames.ModifiedBy;
					ht[CreatedDate] = _FlightCrew.ColumnNames.CreatedDate;
					ht[LastModifiedDate] = _FlightCrew.ColumnNames.LastModifiedDate;
		...
		{  
            public const string ReportCrewID = "s_ReportCrewID";
		...
		public virtual int ReportCrewID
	    {
			get
	        {
				return base.Getint(ColumnNames.ReportCrewID);
			}
			set
	        {
				base.Setint(ColumnNames.ReportCrewID, value);
			}
		}
		...
		public virtual string s_ReportCrewID
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.ReportCrewID) ? string.Empty : base.GetintAsString(ColumnNames.ReportCrewID);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.ReportCrewID);
				else
					this.ReportCrewID = base.SetintAsString(ColumnNames.ReportCrewID, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter ReportCrewID
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.ReportCrewID, Parameters.ReportCrewID);
			...
			public WhereParameter ReportCrewID
		    {
				get
		        {
					if(_ReportCrewID_W == null)
	        	    {
						_ReportCrewID_W = TearOff.ReportCrewID;
					}
					return _ReportCrewID_W;
				}
			}
			...
			private WhereParameter _ReportCrewID_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter ReportCrewID
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.ReportCrewID, Parameters.ReportCrewID);
			...
			private AggregateParameter _ReportCrewID_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FlightCrewInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.ReportCrewID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FlightCrewUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FlightCrewDelete]";
	
			SqlParameter p;
			p = cmd.Parameters.Add(Parameters.ReportCrewID);
			p.SourceColumn = ColumnNames.ReportCrewID;
