<%@ Page Title="" Language="C#" MasterPageFile="~/CompaniesMaster.Master" AutoEventWireup="true" CodeBehind="New_Request.aspx.cs" Inherits="Pricing_GUI.New_Request" %>
...
TBODY TR.odd { background-color:#78a5d1; }
     ...
     <p style="text-align:left">
            <asp:Label runat="server" ID="lblPageTitle" 
                Text="Submit New Product For Pricing" Font-Names="Sakkal Majalla"
                Font-Size="XX-Large" ForeColor="#003366" Font-Underline="True" 
