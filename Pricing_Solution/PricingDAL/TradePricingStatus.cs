...
{
	public abstract class _TradePricingStatus : SqlClientEntity
	{
		public _TradePricingStatus()
		{
			this.QuerySource = "TradePricingStatus";
			this.MappingName = "TradePricingStatus";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_TradePricingStatusLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int TradePricingStatusID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.TradePricingStatusID, TradePricingStatusID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_TradePricingStatusLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[TradePricingStatusID] = _TradePricingStatus.PropertyNames.TradePricingStatusID;
					ht[Name] = _TradePricingStatus.PropertyNames.Name;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[TradePricingStatusID] = _TradePricingStatus.ColumnNames.TradePricingStatusID;
					ht[Name] = _TradePricingStatus.ColumnNames.Name;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TradePricingStatusInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.TradePricingStatusID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TradePricingStatusUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TradePricingStatusDelete]";
