<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/PrintMaster.master"
    AutoEventWireup="true" CodeFile="PrintBirthInfo.aspx.cs" Inherits="RegisterBirthdayInfo"
                        ...
                        <asp:Panel ID="pnlHealthInfo" runat="server" meta:resourcekey="pnlHealthInfoResource1">
                            <table width="100%" dir="rtl">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtBirthLocation" TabIndex="1" runat="server" meta:resourcekey="txtBirthLocationResource1"></asp:TextBox>
