...
<body>
    <form id="form1" runat="server">
     <asp:Login ID="Login1" align="center" runat="server" 
        meta:resourcekey="Login1Resource1" onloggedin="Login1_LoggedIn">
        <LayoutTemplate>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" 
                                        ControlToValidate="UserName" ErrorMessage="مطلوب." 
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="PasswordRequired" runat="server" 
                                        ControlToValidate="Password" ErrorMessage="مطلوب." 
