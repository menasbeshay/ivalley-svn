<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" MaintainScrollPositionOnPostback="true"
    AutoEventWireup="true" CodeFile="RegisterDeathCase.aspx.cs" Inherits="RegisterDeathCase"
...
<script language="javascript" type="text/javascript">
   ...
   <div runat="server" id="DeathCaseConents">
        ...
        <tr>
            ...
            <asp:Panel runat="server" ID="pnlNotifier" Direction="RightToLeft" meta:resourcekey="pnlNotifierResource1">
                <uc3:UcNotifierInfo ID="UcNotifierInfo2" UCType="Dead" NotifierRelationCase="علاقته بالمتوفى" runat="server" />
            </asp:Panel>
            <br />
           ...
           <%-- <asp:CompareValidator ID="CompareValidator14" Display="Dynamic" ValidationGroup="GenralValidate"
            ...
            <table dir="rtl" align="center">
                <tr>
                    <td align="center">
                        <asp:Button ID="btnAdd" Width="150px" ValidationGroup="GenralValidate" Font-Size="Large" runat="server" meta:resourcekey="btnAddResource1"
            ...
            <table align="center" runat="server" id="tblApprove" style="display:none">
                <tr>
                    <td>
                       <asp:Button runat="server" ID="btnApprove" ValidationGroup="approve" OnClick="btnApprove_Click" Text="عرض البيانات الصحية" Width="120px" />
                       <asp:Button runat="server" ID="btnBack" OnClick="btnBack_Click" Text="رجوع" Width="120px" />
                    </td>
                </tr>
            </table>
         </div>
