	...
	public abstract class _Born : SqlClientEntity
	{
		...
		protected class Parameters
		{
			...
			public static SqlParameter InformerAddress
			{
				get
				{
					return new SqlParameter("@InformerAddress", SqlDbType.NVarChar, 400);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[WriterID] = _Born.PropertyNames.WriterID;
					ht[DoctorID] = _Born.PropertyNames.DoctorID;
					ht[InformerAddress] = _Born.PropertyNames.InformerAddress;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[WriterID] = _Born.ColumnNames.WriterID;
					ht[DoctorID] = _Born.ColumnNames.DoctorID;
					ht[InformerAddress] = _Born.ColumnNames.InformerAddress;
