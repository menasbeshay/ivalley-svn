    ...
    <asp:Panel ID="uiPanelCreateFolder" runat="server">
        <div class="form-horizontal blockBox">
            <div class="row">
                ...
                <asp:TextBox ID="uiTextBoxFolderName" runat="server" CssClass="form-control" ></asp:TextBox>
                    </div>          
                <div class="col-sm-1 pull-right">
                    <asp:LinkButton ID="uiLinkButtonSave" runat="server" CssClass="btn btn-main" OnClick="uiLinkButtonSave_Click">حفظ</asp:LinkButton>
                    </div>      
                </div>
            ...
            <div class="row">
                ...
                <asp:GridView ID="uiGridViewFolders" runat="server" CssClass="table table-hover" AutoGenerateColumns="False" OnPageIndexChanging="uiGridViewFolders_PageIndexChanging" HeaderStyle-CssClass="MsgHeader" OnRowCommand="uiGridViewFolders_RowCommand">
            <Columns>
                ...
                <asp:TemplateField HeaderText="إجراءات" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:LinkButton ID="uiLinkButtonEdit" runat="server" CssClass="btn btn-main" CommandArgument='Eval("MessageFolderID")' CommandName="EditFolder">تعديل</asp:LinkButton>
                        <asp:LinkButton ID="uiLinkButtonDelete" runat="server" CssClass="btn btn-main" CommandArgument='Eval("MessageFolderID")' CommandName="DeleteFolder">حذف</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>                
            </Columns>
        </asp:GridView>
    ...
    <asp:Panel ID="uiPanelCreateMsg" runat="server">    
        <div class="form-horizontal blockBox">
            <div class="row">
                ...
                <div class="col-sm-8 pull-right">
                    <asp:DropDownList ID="uiDropDownListFriends" runat="server" CssClass="form-control" Visible="false" >

                    </asp:DropDownList>

                    <asp:TextBox ID="uiTextBoxTo" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:TextBox>
                    <asp:TextBox ID="uiTextboxvalue" runat="server" CssClass="form-control" ClientIDMode="Static" Visible="false"></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 pull-right">
                    <asp:TextBox ID="uiTextBoxSubject" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
            ...
            <div class="row">
                ...
                <textarea id="uiTextBoxMsg" class="form-control" style="height:300px;padding:0 !important;"></textarea>                
                    </div>
            </div>
            <div class="clearfix" style="height:10px;"></div>
            <div class="row">
            ...
            <asp:HiddenField ID="uiHiddenFieldTo" runat="server" />
        </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#uiTextBoxTo').tagit({
                    autocomplete: {
                        source: function (request, response) {
                            $.ajax({
                                ...
                                dataType: "json",
                                type: "post",
                                data: "{'query':'" + request.term.toString() + "','MemberID' : '"+ $('#<%= uiHiddenFieldCurrentMember.ClientID %>').val() +"'}",
                    ...
                    ,
                        select: function (e, i) {
                            $("#<%=uiHiddenFieldTo.ClientID %>").val( $("#<%=uiHiddenFieldTo.ClientID %>").val() + "," + i.item.val);                            
                        }
                    },
                    
                    singleField: true,
                    singleFieldNode: $('#uiTextboxvalue'),
                ...
                Msgeditor = new wysihtml5.Editor('uiTextBoxMsg', { toolbar: 'toolbar', parserRules: wysihtml5ParserRules, useLineBreaks: false, stylesheets: 'css/main.css' });
            });
            ...
            function SendMsg() {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    type: "post",
                    data: "{'ToMember':'" + $('#<%= uiHiddenFieldTo.ClientID %>').val() + "' , 'subject' : '" + $('#<%= uiTextBoxSubject.ClientID %>').val() + "' , 'content' : '" + Msgeditor.getValue() + "'}",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    if (data.d == false) {
