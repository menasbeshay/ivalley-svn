...
<div class="modal-content">
    <div class="modal-header">
        <h3 id="myModalLabel1">خصائص الحساب</h3>
    </div>
    <div class="modal-body">
        <div class="form-horizontal blockBox validationGroup">
            <div class="form-group">
                <div class="SScroll" data-height="300px">
                    <asp:GridView ID="grdMemberRoles" runat="server" AutoGenerateColumns="false" ShowHeader="false" EmptyDataText="لا توجد بيانات" CssClass="table table-condensed" Width="100%">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
