<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RoomChat.ascx.cs" Inherits="Chat2Connect.templates.RoomChat" %>
...
<div id="roomContents" data-bind="with: room()">
    ...
    <div class="col-lg-12">
        ...
        <div style="padding: 5px;" class="pull-right col-lg-2">
            <span class="rating">
                <input type="radio" class='rating-input' data-bind="click:rateRoom.bind($data,5), checked:CurrentMember().UserRate,checkedValue: 5,attr:{id:'rating-input-1-5_'+uniqueID()}" name="rating-input-1" />
                <label data-bind="attr:{'for':'rating-input-1-5_'+uniqueID()}" class="rating-star fa icon-star"></label>
                <input type="radio" class="rating-input" data-bind="click:rateRoom.bind($data,4), checked:CurrentMember().UserRate,checkedValue: 4,attr:{id:'rating-input-1-4_'+uniqueID()}" name="rating-input-1" />
                <label data-bind="attr:{'for':'rating-input-1-4_'+uniqueID()}" class="rating-star fa icon-star"></label>
                <input type="radio" class="rating-input" data-bind="click:rateRoom.bind($data,3), checked:CurrentMember().UserRate,checkedValue: 3,attr:{id:'rating-input-1-3_'+uniqueID()}" name="rating-input-1" />
                <label data-bind="attr:{'for':'rating-input-1-3_'+uniqueID()}" class="rating-star fa icon-star"></label>
                <input type="radio" class="rating-input" data-bind="click:rateRoom.bind($data,2), checked:CurrentMember().UserRate,checkedValue: 2,attr:{id:'rating-input-1-2_'+uniqueID()}" name="rating-input-1" />
                <label data-bind="attr:{'for':'rating-input-1-2_'+uniqueID()}" class="rating-star fa icon-star"></label>
                <input type="radio" class="rating-input" data-bind="click:rateRoom.bind($data,1), checked:CurrentMember().UserRate,checkedValue: 1,attr:{id:'rating-input-1-1_'+uniqueID()}" name="rating-input-1" />
    ...
    <div style="padding: 5px;" class="col-lg-12">
        ...
        <div id="roomTextDiv" class='pull-left ' data-bind="css:{ 'col-lg-9' :Type()=='Room', 'col-lg-12': Type() == 'Private'}, style:{padding: '5px', 'border-right': Type() == 'Room'? '2px solid #FEC200' :'0px'}">
            <!-- ko if: CurrentMember().MemberLevelID()>1 -->
            <div>
                <div data-bind="slideVisible:showAdminPart">
                    ...
                    <a style="width: 8%; height: 35px; padding-top: 7px; float: right;" class="btn btn-main" data-bind="click:sendAdminMessage">إرسال</a>
            ...
            <div data-bind="visible:!(CurrentMember().CanWrite())" style="position: absolute; left: 0; width: 100%; height: 70px; z-index: 2; opacity: 0.4; filter: alpha(opacity = 50)"></div>
            <a style="width: 8%; height: 35px; padding-top: 7px; float: right;" class="btn btn-main" data-bind="click:sendMessage,attr:{id:'a_Send_'+uniqueID()}">إرسال</a>
            ...
            <div class="col-lg-12" style="padding: 0px;">
                ...
                <div class="pull-right btn-group" style="margin-right: 3px;" data-toggle="buttons-checkbox">
                    <button class="btn btn-default" data-bind="attr:{id:'mute_'+uniqueID()}, click:muteRoom.bind($data)" data-mute='false'>×<i class="icon-volume-off" style="font-size: 17px;"></i></button>
                </div>
                    ...
                    <div class="form-horizontal blockBox validationGroup">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 pull-right">
                                <a style="cursor: pointer;" class="btn btn-default " data-bind="click:sendVideo($data)">إرسال</a>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 control-label pull-right">
                                <a style="cursor: pointer;" class="btn btn-default pull-right" data-bind="click:sendImage($data)">إرسال</a>
                            </div>
                        </div>
                        <div style="height: 1px; background-color: #ccc; clear: both; width: 95%; margin: 5px auto;"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7 pull-right center">
                                <object style="height: 138px;" data="testswf/recorder.swf" class="flashmovie" data-bind="attr:{id:'recorder_'+uniqueID(), name:'recorder_'+uniqueID()}" type="application/x-shockwave-flash">
                                    ...
                                    <param value="always" name="allowScriptAccess">
                                    <param name="wmode" value="opaque" />
                                    <param data-bind="attr:{value:'roomId='+ ID() +'&amp;userId='+ $root.memberID+'&amp;recordUrl=audioUploader.ashx'}" name="flashvars">
                                </object>
                            </div>


                            <div class="col-sm-2 control-label pull-right">
                                <a style="cursor: pointer;" class="btn btn-default" data-bind="click:sendAudio($data)">إرسال</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="popup-menu profileMenu">
                ...
                <div class="col-lg-9 pull-right" style="padding: 0 5px;">
                    <div class="col-lg-6 pull-right" style="padding: 0 5px;">
                        <ul>
                            <li><a class="jslink" data-bind="click:$root.openPrivateRoom.bind($data)"><span class="awesome">&#xf0e6;</span> محادثة خاصة</a></li>
                            <!-- ko if: IsCamOpened()-->
                            <li><a class="jslink" data-bind="click:startCam.bind($parent,$data.MemberID())"><span class="awesome">&#xf030;</span> عرض الكاميرا</a></li>
                            <!-- /ko -->
...
<script type="text/html" id="bot_editTemplate">
    <div class="box">
        <div class="icon">
            <img class="image" data-bind="attr:{'src' : Bot.IconPath() +'_'+$root.selectedTab().typeSpecID()+'.png'}" />
            <div class="info">
                ...
                <div class="more">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="clearfix"></div>
                        <div data-bind="template: { name: function(){return 'bot_template_'+$data.BotID()}()}"></div>
                        <div class="clearfix"></div>
                    </form>
                </div>
            </div>
