<%@ Page Title="" Language="C#" MasterPageFile="~/Projrcts_en.Master" AutoEventWireup="true" CodeBehind="Projects_en.aspx.cs" Inherits="archiplan.Projects_en" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <asp:Repeater ID="uiRepeaterCats" runat="server">
            <ItemTemplate>
                <div style="float:left;width:22%;padding:5px;margin:5px;">
                    <a href='Projects_en.aspx?cid=<%# Eval("ID") %>' class="butt"
                        id="cat_<%# Eval("ID") %>"> 
                        <img src='Images.aspx?Inner=product&Image=<%# Eval("MainPic") %>' /> <br /> <%# Eval("CategoryName_en") %></a>
                </div>
            </ItemTemplate>
            <FooterTemplate>
    ...
    <asp:Panel ID="uiPanelProducts" runat="server">
        ...
        <asp:Repeater ID="uiRepeaterProducts" runat="server">
            ...
            <ItemTemplate>
                <div style="float: left; width: 22%; padding: 5px; margin: 5px;" >
                    <a href='Projects_en.aspx?pid=<%# Eval("ProductID") %>&cid=<%# Eval("CategoryID") %>'
                        title='<%# Eval("ProductName_en") %>' alt='<%# Eval("ProductName_en") %>'>
                        <span  style="font-weight:normal;"><%# Eval("ProductName_en") %></span>
                        <div class="clear5" ></div>
    ...
    <asp:Panel ID="uiPanelProductDetails" runat="server">
        ...
        <div style="width:100%;float:left;">
            ...
            <div style="text-align:left;padding-left:20px;font-size:14px;color:#a2a2a2;" >
