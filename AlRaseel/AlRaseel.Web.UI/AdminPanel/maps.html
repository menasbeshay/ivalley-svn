...
<body data-page="maps">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-center">Google Maps</div>
    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            <div class="page-title"> <i class="icon-custom-left"></i>
                <h3><strong>Customize</strong> your maps to fit your design</h3>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-default map-panel">
                        <div class="panel-body">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Simple</strong> Map</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="panel panel-default map-panel">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="map" id="style-map"></div>
                                </div>
                            </div>
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Styled</strong> Map</h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default map-panel">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><strong>Route</strong> Map</h3>
                                    </div>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default map-panel">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="map" id="geocoding-map"></div>
                                </div>
                            </div>
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Geocoding</strong> Map</h3>
                        ...
                        <button type="submit" class="btn bg-blue" type="button">Search!</button>
                      </span>
                                        </div>
                                    </form>
                                </div>
