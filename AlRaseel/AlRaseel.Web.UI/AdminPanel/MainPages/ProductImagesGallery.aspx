<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductImagesGallery.aspx.cs" Inherits="Web.UI.AdminPanel.MainPages.ProductImagesGallery" %>
                            ...
                            <td>
                                <asp:ListView ID="lstview" runat="server" GroupItemCount="4" DataSourceID="objImages"
                                    ...
                                    <ItemTemplate>
                                        <td>
                                            <div class="imgIcon">
                                                <a class="gallery" href='<%#"../../Files/Images/"+ Eval("ImgFile") %>'>
                                                    <asp:Image ID="img" ImageUrl='<%#"~/Files/Images/"+ Eval("ImgFile") %>'
                                ...
                                <asp:ObjectDataSource ID="objImages" runat="server" SelectMethod="LoadById" TypeName="Data.Repositories.ProductImagesRepositories">
                                    <SelectParameters>
                                        <asp:Parameter Name="ID" Type="String" DefaultValue="ProductId" />
                                    </SelectParameters>
