<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="AlbumImagesGallery.aspx.cs" Inherits="Web.UI.AdminPanel.MainPages.AlbumImagesGallery" %>
...
<%--                                                    <asp:Image ID="Image1" CssClass="imgIcon tip_right_top" title='<%# Data.Extensions.GeneralMethods.GetRecordInfo(Eval("CreatedOn").ToString(),Eval("CreatedBy").ToString(),Eval("ModifiedOn").ToString(),Eval("ModifiedBy").ToString()) %>'
                                    ...
                                    <asp:ObjectDataSource ID="objImages" runat="server" SelectMethod="LoadByProductAlbumId" TypeName="Data.Repositories.AlbumImagesRepository">
                                        <SelectParameters>
                                            <asp:Parameter Name="ProductAlbumId" Type="String" DefaultValue="ProductAlbumId" />
                                        </SelectParameters>
