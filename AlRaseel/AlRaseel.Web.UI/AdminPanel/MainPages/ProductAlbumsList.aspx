<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="ProductAlbumsList.aspx.cs" Inherits="Web.UI.AdminPanel.MainPages.ProductAlbumsList" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div style="float: right;">
                        <a class="btn btn-blue" href="ProductAlbumsManagement.aspx" runat="server">AddNew...</a>
                        ...
                        <div class="col-md-12">
                            ...
                            <div>
                                <div class="form-group col-md-4">
                                    ...
                                    <asp:DropDownList ID="ddlProducts" AutoPostBack="true" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlLanguage_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HyperLink ID="imgEdit" runat="server" CssClass="grdimgicon" NavigateUrl='<%#"~/AdminPanel/MainPages/ProductAlbumsManagement.aspx?ID="+Eval("Id")%>'
