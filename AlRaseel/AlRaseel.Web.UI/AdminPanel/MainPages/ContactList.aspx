<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="ContactList.aspx.cs" Inherits="Web.UI.AdminPanel.MainPages.ContactList" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div style="float: right;">
                        <a class="btn btn-blue" href="~/AdminPanel/MainPages/ContactManagement.aspx" runat="server">AddNew...</a>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HyperLink ID="imgEdit" runat="server" CssClass="grdimgicon" NavigateUrl='<%#"~/AdminPanel/MainPages/ContactManagement.aspx?ID="+Eval("Id")%>'
