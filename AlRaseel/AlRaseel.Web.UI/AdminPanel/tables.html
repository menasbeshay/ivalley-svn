...
<body data-page="tables">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-center">Styled Tables</div>
        ...
        <div id="main-content">
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody class="no-bd-y">
                                            <tr>
                                                ...
                                                <td class="text-left color-success">$25.2</td>
                                                <td>05/14/2013</td>
                                                <td class="color-success">
                                                    <div class="progress">
                                                        <div class="progress-bar progress-bar-success" aria-valuetransitiongoal="75">75%</div>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div class="sparkline" data-sparkline-color="#7BB2B4" data-sparkline-value="[13,14,16,15,4,14,20,14,12,16,11,17,19,16]">
                                                </td>
                                                <td class="text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left color-success">$22.5</td>
                                                <td>05/14/2013</td>
                                                <td class="color-success">
                                                    <div class="progress">
                                                        <div class="progress-bar progress-bar-danger" aria-valuetransitiongoal="21">21%</div>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div class="sparkline" data-sparkline-color="#c3a8db" data-sparkline-value="[14,17,16,12,15,16,22,15,14,17,11,18,11,12]">
                                                </td>
                                                <td class="text-center">
                                                    <input class="switch" type="checkbox" checked data-size="mini">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left color-success">$21</td>
                                                <td>05/14/2013</td>
                                                <td class="color-success">
                                                    <div class="progress">
                                                        <div class="progress-bar progress-bar-success" aria-valuetransitiongoal="58">58%</div>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div class="sparkline" data-sparkline-color="#8dae24" data-sparkline-value="[18,14,15,14,13,12,21,16,18,14,12,15,17,19]">
                                                </td>
                                                <td class="text-center">
                                                    <input class="switch" type="checkbox" checked data-size="mini">
                                                </td>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Contextual <strong>Table</strong></h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Bordered</strong> Table</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Hover <strong>Table</strong></h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
