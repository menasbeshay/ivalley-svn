...
<body data-page="modals">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-center">Modals</div>
    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            <div class="page-title"> <i class="icon-custom-left"></i>
                <h3><strong>Be original</strong> with custom modals</h3>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Beautiful</strong> customized Modals</h3>
                        </div>
                        <div class="panel-body modal-panel">
                            <div class="row">
                                <div class="col-md-3">
                                    <h3><strong>Fade and Slide</strong> effects</h3>
                                    <p>Simple modal with title and footer</p>
                                    <br>
                                    <button class="btn btn-danger" data-modal="modal-1">Fade in &amp; Scale</button>
                                    <button class="btn btn-danger" data-modal="modal-2">Slide in (right)</button>
                                    <button class="btn btn-danger" data-modal="modal-3">Slide in (bottom)</button>
                                </div>
                                <div class="col-md-3">
                                    <h3><strong>Flip and Rotate</strong> effects</h3>
                                    <p>You can customize the size of your modal. Just add the class <code>modal-lg</code>.</p>
                                    <button class="btn btn-primary" data-modal="modal-8">3D Flip (horizontal)</button>
                                    <button class="btn btn-primary" data-modal="modal-9">3D Flip (vertical)</button>
                                    <button class="btn btn-primary" data-modal="modal-10">3D Sign</button>
                                    <button class="btn btn-primary" data-modal="modal-14">3D Rotate Bottom</button>
                                    <button class="btn btn-primary" data-modal="modal-15">3D Rotate In Left</button>
                                    <button class="btn btn-primary" data-modal="modal-13">3D Slit</button>
                                </div>
                                <div class="col-md-3">
                                    <h3><strong>Other</strong> effects</h3>
                                    <p>For fullwidth modal, add the class <code>modal-full</code>.</p>
                                    <br>
                                    <button class="btn btn-dark" data-modal="modal-4">Newspaper</button>
                                    <button class="btn btn-dark" data-modal="modal-5">Fall</button>
                                    <button class="btn btn-dark" data-modal="modal-6">Side Fall</button>
                                    <button class="btn btn-dark" data-modal="modal-7">Sticky Up</button>
                                    <button class="btn btn-dark" data-modal="modal-11">Super Scaled</button>
                                    <button class="btn btn-dark" data-modal="modal-12">Just Me</button>
                                </div>
                                <div class="col-md-3">
                                    <h3><strong>Color</strong> variation</h3>
                                    <p>Like in a normal page, you can add class to make your modal responsive, <code>col-md-4</code> for example.</p>
                                    <button class="btn btn-primary" data-modal="modal-16">Blue</button>
                                    <button class="btn btn-danger" data-modal="modal-17">Red</button>
                                    <button class="btn btn-dark" data-modal="modal-18">Dark</button>
                                    <button class="btn btn-default" data-modal="modal-19">White</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Bootstrap</strong> Modals</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <h3><strong>Basic</strong> modals</h3>
                                    <p>Simple modal with title and footer</p>
                                    <br>
                                    <button class="btn btn-danger" data-toggle="modal" data-target="#modal-basic">Show me</button>
                                </div>
                                <div class="col-md-3">
                                    <h3><strong>Large</strong> width</h3>
                                    <p>You can customize the size of your modal. Just add the class <code>modal-lg</code>.</p>
                                    <button class="btn btn-danger" data-toggle="modal" data-target="#modal-large">Show me</button>
                                </div>
                                <div class="col-md-3">
                                    <h3><strong>Full</strong> width</h3>
                                    <p>For fullwidth modal, add the class <code>modal-full</code>.</p>
                                    <br>
                                    <button class="btn btn-danger" data-toggle="modal" data-target="#modal-full">Show me</button>
                                </div>
                                <div class="col-md-3">
                                    <h3><strong>Responsive</strong> modals</h3>
                                    <p>Like in a normal page, you can add class to make your modal responsive, <code>col-md-4</code> for example.</p>
                                    <button class="btn btn-danger" data-toggle="modal" data-target="#modal-responsive">Show me</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="md-modal md-effect-1" id="modal-1">
                <div class="md-content">
                    ...
                    <div>
                        ...
                        <button class="btn btn-default">Close me!</button>
                    </div>
                </div>
            </div>
            ...
            <div class="md-modal md-effect-1" id="modal-18">
                <div class="md-content md-content-dark">
                    <h3>Modal Dialog</h3>
                    <div>
                        <p>This is a modal window. You can do the following things with it:</p>
                        <ul>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel"><strong>Basic</strong> modal</h4>
                        </div>
            ...
            <div class="modal fade" id="modal-large" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="myModalLabel"><strong>Large width</strong> modal</h4>
                        </div>
                        <div class="modal-body">
                            My content...
                        </div>
            ...
            <div class="modal fade" id="modal-full" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-full">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="myModalLabel"><strong>Fullwidth</strong> modal</h4>
                        </div>
                        <div class="modal-body">
                            My content...
                        </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel"><strong>Responsive</strong> modal <small>Change screensize to see</small></h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6">
