    ...
    <div class="mainContent">
        ...
        <div class="Left">
            ...
            <asp:Button ID="uiButtonViewResult" runat="server" Text="عرض النتائج"
                OnClick="uiButtonViewResult_Click" />
        </div>
        <div class="clear">
        </div>
                                                                ...
                                                                <td>
                                                                    <div align="center">
                                                                        <table border="0" width="430" cellspacing="0" cellpadding="0" style="display: none">
                                                                            <tr>
                                                                                <td class="tittle_nepete" dir="rtl" style="font-weight: bold; text-align: center">مدير 
													المدرسة</td>
                                                                            ...
                                                                            <tr>
                                                                                <td class="tittle_nepete" dir="rtl" style="font-weight: bold; text-align: center">عبد الغنى 
													محمد عبد الغنى</td>
                                                                                <td class="tittle_nepete">&nbsp;</td>
                                                                                <td class="tittle_nepete">&nbsp;</td>
                                                                                <td class="tittle_nepete">&nbsp;</td>
                                        ...
                                        <div align="center">
                                            <table border="0" width="700" cellspacing="0" cellpadding="0" height="471">
                                                <tr>
													...
													الطالب 
													:</span></td>
                                                                                <td width="25" class="tittle_petroli">&nbsp;</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td dir="rtl">
                                                                                ...
                                                                                <td width="25" dir="rtl" class="tittle_petroli">&nbsp;</td>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
                                                                </td>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <div style="border: 1px solid #aaa; float: right;">
                                                                                <div style="position: relative; height: 130px; padding-top: 10px; vertical-align: middle;">
                                                                                    <div style="direction: rtl; display: block; font-weight: bold; -ms-writing-mode: bt-rl; width: 35px; overflow: visible; white-space: nowrap; -webkit-transform: rotate(270deg); -moz-transform: rotate(270deg); -ms-transform: rotate(270deg); -o-transform: rotate(270deg); transform: rotate(270deg);">
                                                                                        <%# Eval("ArCourseName") %>
                                                                                    </div>
                                                                                </div>
        ...
        <asp:Panel ID="uiPanelPrepratory" runat="server" Visible="false">
            <table border="0" width="100%" cellspacing="0" cellpadding="0" dir="ltr">
                <tr>
                    <td>
                        <p align="center">
                            <span lang="ar-eg"><strong>نتيجة المرحلة الاعدادية</strong></span>
                    </td>
                </tr>
                <tr>
                    <td>
                                        ...
                                        <div align="center">
                                            <table border="0" width="700" cellspacing="0" cellpadding="0" height="471">
                                                <tr>
													...
													الطالب 
													:</span></td>
                                                                                <td width="10" class="tittle_petroli">&nbsp;</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td dir="rtl">
                                                                                ...
                                                                                <td width="10" dir="rtl" class="tittle_petroli">&nbsp;</td>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
                                                                </td>
