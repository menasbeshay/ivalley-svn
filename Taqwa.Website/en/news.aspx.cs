        ...
        private void BindData()
        {
            ...
            if (done)
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    {
                        uiLabelTitle.Text = ds.Tables[0].Rows[0]["EnTitle"].ToString();
                        uiLiteralContent.Text = Server.HtmlDecode(ds.Tables[0].Rows[0]["EnBody"].ToString());
                    }
                    else
                    {
                        Response.Redirect("~/en/News.aspx");
                    }
