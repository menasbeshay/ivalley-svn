                ...
                <HeaderTemplate>
                    <table style="width: 80%; border: 1px solid black; border-collapse: collapse; text-align: center;">
                        <tr>
                            ...
                            <td id="tdDegree" runat="server">الدرجة
                            </td>
                            <td id="tdGrade" runat="server">التقدير
                            </td>
                        </tr>
                </HeaderTemplate>
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="uiTextBoxGrade" runat="server" Width="100" Visible='<%# !(Eval("ClassID").ToString() == "1" || Eval("ClassID").ToString() == "2") %>'> </asp:TextBox>
                        </td>
                        <td>
                            <asp:DropDownList ID="uiDropDownListEval" runat="server" Visible='<%# (Eval("ClassID").ToString() == "1" || Eval("ClassID").ToString() == "2") %>'>
                                <asp:ListItem Text="دون المستوي" />
                                <asp:ListItem Text="مقبول" />
