<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="EditTopLevelCat_ps.aspx.cs" Inherits="E3zemni_WebGUI.Admin.EditTopLevelCat_ps" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script type="text/javascript">
    $(document).ready(function () {
        $("#TopcatsPSItem").addClass("current");
 ...
 <asp:Panel ID="uiPanelEditCat" runat="server" DefaultButton="uiLinkButtonOK">
        <div class="row">
            <div class="grid_12">
                        ...
                        <h4>
                           Add / Edit Top Level Categories </h4>
