...
{
    public partial class EditTopLevelCat_ps : System.Web.UI.Page
    {
        #region properties
        public TopLevelCat CurrentTopCat
        {
            get
            {
                if (Session["CurrentTopCatPS"] != null)
                    return (TopLevelCat)Session["CurrentTopCatPS"];
                else
                    return null;
            }
            set
            {
                Session["CurrentTopCatPS"] = value;
            }
        }
