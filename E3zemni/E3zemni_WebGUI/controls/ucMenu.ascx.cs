...
namespace E3zemni_WebGUI.controls
{
    public partial class ucMenu : System.Web.UI.UserControl
    {
        ...
        private void LoadTopCats()
        {
            ...
            {
                menu += "<li><a href='browse.aspx?tcid=" + cats.TopLevelCatID.ToString() + "'>" + cats.NameEng + "</a> ";
        ...
        private string LoadMainCats(int p)
        {
            ...
            if (scat.RowCount > 0)
            {
                ...
                {
                    submenu += "<li><a href='browse.aspx?tcid=" + scat.TopLevelCatID.ToString() + "&mcid=" + scat.MainCatID.ToString() + "'>" + scat.NameEng + "</a>";
        ...
        private string LoadCats(int p)
        {
            ...
            if (scat.RowCount > 0)
            {
                ...
                for (int i = 0; i < scat.RowCount; i++)
                {
                    submenu += "<li><a href='browse.aspx?catid=" + scat.CategoryID.ToString() + "'>" + scat.CatNameEng + "</a> </li>";
                    scat.MoveNext();
                }
                submenu += "</ul>";
            }
