						...
						<div class="bag_table">
                            ...
                            <HeaderTemplate>
                                <table class="shop_table footable tablet footable-loaded" cellspacing="0">
									<thead>
										<tr>
											<th data-hide="phone" class="product-thumbnail">الصنف </th>											
											...
											<td class="product-quantity">
												<div class="quantity buttons_added">
                                                    <asp:TextBox ID="uiTextBoxQty" runat="server" CssClass="qty" Text='<%# Eval("CardCount") %>'></asp:TextBox>                                                    
                                                     <br />
                                                      <asp:Label ID="uiLabelMaxQty" runat="server" Text="أقل عدد مسموح (30)" style="font-size:10px" ></asp:Label>
                            ...
                            <tr>
											...
											<td class="product-quantity">الإجمالى</td>
