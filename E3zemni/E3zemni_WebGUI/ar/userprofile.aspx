<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Ar.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="E3zemni_WebGUI.ar.userprofile" %>
          ...
          <div class="row">
            <div class="col-md-5">
                <asp:LinkButton ID="uiLinkButtonRegister" runat="server"  
                    ...
                    onclick="uiLinkButtonRegister_Click">حفظ </asp:LinkButton>              
            </div>
          </div>
