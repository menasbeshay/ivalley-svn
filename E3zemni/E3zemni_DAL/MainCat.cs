...
{
	public abstract class _MainCat : SqlClientEntity
	{
		public _MainCat()
		{
			this.QuerySource = "MainCat";
			this.MappingName = "MainCat";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_MainCatLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int MainCatID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.MainCatID, MainCatID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_MainCatLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[MainCatID] = _MainCat.PropertyNames.MainCatID;
					ht[NameEng] = _MainCat.PropertyNames.NameEng;
					ht[NameAr] = _MainCat.PropertyNames.NameAr;
					ht[TopLevelCatID] = _MainCat.PropertyNames.TopLevelCatID;
					ht[ImagePath] = _MainCat.PropertyNames.ImagePath;
					ht[HoverImage] = _MainCat.PropertyNames.HoverImage;
					ht[IsPartySupplier] = _MainCat.PropertyNames.IsPartySupplier;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[MainCatID] = _MainCat.ColumnNames.MainCatID;
					ht[NameEng] = _MainCat.ColumnNames.NameEng;
					ht[NameAr] = _MainCat.ColumnNames.NameAr;
					ht[TopLevelCatID] = _MainCat.ColumnNames.TopLevelCatID;
					ht[ImagePath] = _MainCat.ColumnNames.ImagePath;
					ht[HoverImage] = _MainCat.ColumnNames.HoverImage;
					ht[IsPartySupplier] = _MainCat.ColumnNames.IsPartySupplier;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_MainCatInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.MainCatID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_MainCatUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_MainCatDelete]";
