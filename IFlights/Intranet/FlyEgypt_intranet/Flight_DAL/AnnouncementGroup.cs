...
{
	public abstract class _AnnouncementGroup : SqlClientEntity
	{
		public _AnnouncementGroup()
		{
			this.QuerySource = "AnnouncementGroup";
			this.MappingName = "AnnouncementGroup";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_AnnouncementGroupLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int AnnouncementID, int GroupID)
		{
...
parameters.Add(Parameters.GroupID, GroupID);
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_AnnouncementGroupLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[AnnouncementID] = _AnnouncementGroup.PropertyNames.AnnouncementID;
					ht[GroupID] = _AnnouncementGroup.PropertyNames.GroupID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[AnnouncementID] = _AnnouncementGroup.ColumnNames.AnnouncementID;
					ht[GroupID] = _AnnouncementGroup.ColumnNames.GroupID;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_AnnouncementGroupInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_AnnouncementGroupUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_AnnouncementGroupDelete]";
