...
{
    public partial class AircraftManuals : System.Web.UI.Page
    {
        ...
        protected void MarkNotificationsAsRead()
        {
            ...
            userNotif.MarkNotificationsReadByNotificationType((new Guid(Membership.GetUser(Page.User.Identity.Name).ProviderUserKey.ToString())), 5);
        }
    }
}