<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ARMaster.Master" AutoEventWireup="true" CodeBehind="Vedios.aspx.cs" Inherits="GlobalLogistics.WebSite.Vedios" %>
        ...
        <div class="Details675">
            ...
            <asp:Panel ID="uiPanelVedio" runat="server">
                <asp:Repeater ID="uiRepeaterVedio" runat="server">
                    <ItemTemplate>
                        <asp:Label CssClass="videoTitle" ID="uiLabeltTitle" runat="server" Text='<%# Eval("ArTitle") %>'></asp:Label>
                        <br />
                        <asp:Label ID="uiLabelDesc" runat="server" Text='<%# Eval("ArDescription") %>'></asp:Label>
                        <div class="clear10">
                        </div>
                        <iframe width="640" height="400" src='<%# Eval("URL") %>' frameborder="0"
