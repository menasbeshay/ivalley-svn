<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GlobalLogistics.WebSite.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="ContentLeft2">
        ...
        <div class="ContentLeftDivRight">
            <a href="Service.aspx?T=off" class="blue_med ir" style="margin-left: 5px;">blue med</a> 
            <a href="Service.aspx?T=req" class="green_med ir">green med</a> 
            <a href="Service.aspx?T=job" class="yellow_med ir">yellow med</a>
            <div class="clear10">
            </div>
