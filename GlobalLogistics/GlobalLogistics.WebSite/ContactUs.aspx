<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ARMaster.Master" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="GlobalLogistics.WebSite.Arabic.ContactUs" %>
...
<div class="ContentLeftDiv">
                ...
                <div class="Details675">
                    ...
                    <div class="AdminRight" style="width: 120px">
                        <asp:Label ID="Label6" runat="server" Text="العنوان :" 
                            CssClass="Label"></asp:Label>
                    </div>
                    <div class="AdminMiddle">
                    ...
                    <div class="AdminMiddle">
                        <asp:TextBox ID="uiTextBoxComments" runat="server" ValidationGroup="EditPage" 
                            Width="400px" Height="80px" TextMode="MultiLine"></asp:TextBox>
                    </div>
                    <div class="AdminLeft">
                    </div>
                    <div class="clear5">
