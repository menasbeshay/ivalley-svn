<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditPackageOptions.aspx.cs" Inherits="GlobalLogistics.WebSite.Administrator.EditPackageOptions" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script type="text/javascript">
    $(function () {
        $("#mi4").addClass("selected");
    });
</script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="AdminMain" style="direction: rtl;">
        <asp:Panel ID="uiPanelViewPackageOptions" runat="server">
        <div class="ContentLeftDiv">
            ...
            <div class="AdminRight">
                <div class="AdminMore" style="width: 150px">
                    <asp:LinkButton ID="uiLinkButtonAdd" runat="server" 
                        OnClick="uiLinkButtonAdd_Click">إضافة خيارات جديدة</asp:LinkButton>
                </div>
            </div>
            ...
            <div class="AdminMiddle" style="width:90%">
                <asp:GridView ID="uiGridViewPackageOptions" runat="server" AutoGenerateColumns="False"
                    OnRowCommand="uiGridViewPackageOptions_RowCommand"                     
                    EnableModelValidation="True" AllowPaging="True" HorizontalAlign="Center" 
                    Width="100%" 
                    onpageindexchanging="uiGridViewPackageOptions_PageIndexChanging">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="إجراءات">
                            <ItemTemplate>
                                <asp:LinkButton ID="uiLinkButtonEdit" runat="server" CommandArgument='<%# Eval("PackageOptionID") %>'
                                    CommandName="EditPackageOption">تعديل</asp:LinkButton>&nbsp;
                                <asp:LinkButton ID="uiLinkButtonDelete" runat="server" CommandArgument='<%# Eval("PackageOptionID") %>'
                                    CommandName="DeletePackageOption" OnClientClick="return confirm('Are you want to delete this record?');">حذف</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
