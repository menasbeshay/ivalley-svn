<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Times.ascx.cs" Inherits="GlobalLogistics.WebSite.Controls.Times" %>
<!-- Times -->
                                        ...
                                        <td>
                                            <div id="flash_container_tt4bed1c34ee59e">
                                                <embed type="application/x-shockwave-flash" src="clock_final.swf" style="" id="main"
                                                    ...
                                                    height="115" width="115"></div>
                                            <script type="text/javascript">
                                                var flashMap = new SWFObject("http://24timezones.com/timescript/clock_final.swf", "main", "115", "115", "7.0.22", "#FFFFFF", true)
                                        ...
                                        <td>
                                            <div id="flash_container_tt4bf29b9dc9f15">
                                                <embed type="application/x-shockwave-flash" src="clock_final.swf"
                                                    ...
                                                    flashvars="color=FF0000&amp;logo=1&amp;city=225111" allowscriptaccess="always"
                                                    height="115" width="115"></div>
                                            <script type="text/javascript">
                                                var flashMap = new SWFObject("http://24timezones.com/timescript/clock_final.swf", "main", "115", "115", "7.0.22", "#FFFFFF", true)
                                                flashMap.addParam("movie", "http://24timezones.com/timescript/clock_final.swf");
