<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master"
    AutoEventWireup="true" CodeBehind="EditServices.aspx.cs" Inherits="GlobalLogistics.WebSite.Administrator.EditServices" %>
<%@ Register Assembly="FredCK.FCKeditorV2" Namespace="FredCK.FCKeditorV2" TagPrefix="FCKeditorV2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script type="text/javascript">
    $(function () {
        $("#mi12").addClass("selected");
    });
</script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="AdminMain"  style="direction: rtl;">
        ...
        <div class="ContentLeftDiv">
            ...
            <div class="AdminRight">
            <asp:Label ID="Label6" runat="server" Text="نوع الخدمة :" CssClass="Label"></asp:Label>     
                
            </div>
            <div class="AdminMiddle">
                <asp:DropDownList ID="uiDropDownListServiceTypes" runat="server"                     
                    Width="200px">
                </asp:DropDownList>
            </div>
            <div class="AdminLeft">
            ...
            <div class="AdminMiddle" style="width: 95%">
                <asp:GridView ID="uiGridViewServices" runat="server" AutoGenerateColumns="False"
                    OnRowCommand="uiGridViewServices_RowCommand"                     
                    EnableModelValidation="True" AllowPaging="True" HorizontalAlign="Center" 
                    Width="100%" onpageindexchanging="uiGridViewServices_PageIndexChanging">
                    <Columns>
        ...
        <div class="ContentLeftDiv">
            ...
            <div class="AdminRight">
                <asp:Label ID="Label3" runat="server" Text="الوصف بالإنجليزية :" CssClass="Label"></asp:Label>
            </div>
            <div class="AdminMiddle">
            </div>
            <div class="AdminLeft">
            ...
            <div class="AdminRight">
                <asp:Label ID="Label4" runat="server" Text="الوصف بالعربية :" CssClass="Label"></asp:Label>
            </div>
            <div class="AdminMiddle">
