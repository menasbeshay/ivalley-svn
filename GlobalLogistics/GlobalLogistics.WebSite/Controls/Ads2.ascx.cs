...
{
    public partial class Ads2 : System.Web.UI.UserControl
    {
        ...
        private void LoadLocationDefaults()
        {
            ...
            location1.LoadByPrimaryKey(2);
            uiLiteralScript.Text = "<script type=\"text/javascript\">$(document).ready(function () {$('#Ad2').cycle({ fx: 'fade' , timeout: " + location1.AdsTimeout.ToString() + " }); }); </script>";
        }

        private void BindArabicData()
        {
            BLL.Ads objData = new BLL.Ads();
            objData.GetAllAdsByLocation(2);
