...
namespace GlobalLogistics.DAL
{
	public abstract class _Currency : SqlClientEntity
	{
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int CurrencyID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.CurrencyID, CurrencyID);
		...
		protected class Parameters
		{
			...
			public static SqlParameter Code
			{
				get
				{
					return new SqlParameter("@Code", SqlDbType.NVarChar, 10);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[CurrencyID] = _Currency.PropertyNames.CurrencyID;
					ht[EnName] = _Currency.PropertyNames.EnName;
					ht[ArName] = _Currency.PropertyNames.ArName;
					ht[Code] = _Currency.PropertyNames.Code;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[CurrencyID] = _Currency.ColumnNames.CurrencyID;
					ht[EnName] = _Currency.ColumnNames.EnName;
					ht[ArName] = _Currency.ColumnNames.ArName;
					ht[Code] = _Currency.ColumnNames.Code;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			SqlParameter p;
			p = cmd.Parameters[Parameters.CurrencyID.ParameterName];
