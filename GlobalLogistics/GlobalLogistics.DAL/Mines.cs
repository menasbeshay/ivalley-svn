...
{
	public abstract class _Mines : SqlClientEntity
	{
		public _Mines()
		{
			this.QuerySource = "Mines";
			this.MappingName = "Mines";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_MinesLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int MinID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.MinID, MinID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_MinesLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[MinID] = _Mines.PropertyNames.MinID;
					ht[EnName] = _Mines.PropertyNames.EnName;
					ht[ArName] = _Mines.PropertyNames.ArName;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[MinID] = _Mines.ColumnNames.MinID;
					ht[EnName] = _Mines.ColumnNames.EnName;
					ht[ArName] = _Mines.ColumnNames.ArName;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_MinesInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.MinID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_MinesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_MinesDelete]";
