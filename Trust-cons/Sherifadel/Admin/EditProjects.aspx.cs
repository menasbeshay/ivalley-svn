...
namespace Sherifadel.Admin
{
    public partial class EditProjects : System.Web.UI.Page
    {
        ...
        private void AddNewRecord()
        {
            ...
            db.AddProductContent(uiTextBoxName.Text, filepath, Convert.ToInt32(uiDropDownListCats.SelectedValue), thumbfilepath, Server.HtmlEncode(uiFCKeditorDesc.Value), "");
        ...
        private void UpdateRecord()
        {
            ...
            db.SetProductContent(CurrentProduct, uiTextBoxName.Text, filepath, thumbfilepath, Server.HtmlEncode(uiFCKeditorDesc.Value), "");
