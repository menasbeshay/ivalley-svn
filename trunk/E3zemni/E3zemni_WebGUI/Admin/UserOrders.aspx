<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="UserOrders.aspx.cs" Inherits="E3zemni_WebGUI.Admin.UserOrders" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script type="text/javascript">
    $(document).ready(function () {
        $("#orderItem").addClass("current");        
    });
</script>
</asp:Content>
                        ...
                        <asp:Panel ID="uipanelError" runat="server" >
                            <div class="alert alert-error">
                                <button class="close" data-dismiss="alert">
                                    ×</button>
                                <strong>Error!</strong> An error occurred. Can't delete this order.
                            </div>
                        </asp:Panel>
                        ...
                        <asp:GridView ID="uiGridViewCats" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Actions">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="uiLinkButtonEdit" runat="server" CommandArgument='<%# Eval("TopLevelCatID") %>'
                                            CssClass="btn btn-default" CommandName="EditCat"> Edit</asp:LinkButton>&nbsp;
                                        <asp:LinkButton ID="uiLinkButtonDelete" runat="server" CommandArgument='<%# Eval("TopLevelCatID") %>'
