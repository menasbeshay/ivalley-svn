        ...
        <asp:Panel ID="pnllogin" runat="server">
            <div class="divLoginStyle">
                ...
                <%--                <table style="width: 96%; margin-left: 10px">
                    <tr>
                        <td style="width: 366px !important; text-align: center; background-color: #660033 !important">
                            <asp:Label ID="lblTitle1" runat="server" ForeColor="White" Font-Bold="true"></asp:Label>
                        </td>
                        <td style="width: 366px !important; text-align: center; background-color: #660033 !important">
                            <asp:Label ID="lblTitle2" runat="server" ForeColor="White" Font-Bold="true"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="background-color: white; width: 280px; height: 222px">
                            <asp:Image ID="imgDetails1" runat="server" CssClass="imgDetails1" ImageUrl="Images/S170_193/Product2c97f88b74cc462292a5cfdadd914e83.png" />
                        </td>
                        <td style="background-color: white; width: 280px; height: 222px">
                            <asp:Image ID="imgDetails2" runat="server" CssClass="imgDetails1" ImageUrl="Images/S170_193/Product2c97f88b74cc462292a5cfdadd914e83.png" />
                        </td>
                    </tr>
                </table>
                --%>
