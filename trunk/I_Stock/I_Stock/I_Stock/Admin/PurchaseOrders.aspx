<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpages/IStock.Master" AutoEventWireup="true" CodeBehind="PurchaseOrders.aspx.cs" Inherits="I_Stock.Admin.PurchaseOrders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="uiPanelEditPurchaseOrder" runat="server">
        <div class="row-fluid">
            <div class="span12">
                <div class="widget">
                    <div class="widget-title">
                        <h4>
                            <i class="icon-reorder"></i>إضافة / تعديل أمر توريد</h4>
                    ...
                    <div class="widget-body form">
                        ...
                        <asp:Panel ID="uiPanelItems" runat="server" GroupingText="الأصناف">
                            <div class="form-horizontal">
                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:DropDownList ID="uiDropDownListItems" runat="server" CssClass="input-large"
                                                Width="225px" Style="display:none;">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="span12">
                                        <label class="control-label">
                                            عدد العبوات / الكرتونات</label>
                                        <div class="controls">
                                            <asp:TextBox ID="uiTextBoxNoOfPackages" runat="server" CssClass="input-large" data-validation-engine="validate[required, custom[integer]]"></asp:TextBox>                                           
                                        </div>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="span12">
                                        <label class="control-label">
                                            عدد الصنف بكل عبوة / كرتونة</label>
                                        <div class="controls">
                                            <asp:TextBox ID="uiTextBoxItemOnPackages" runat="server" CssClass="input-large" data-validation-engine="validate[required, custom[integer]]"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    <asp:GridView ID="uiGridViewItems" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        onrowdatabound="uiGridViewItems_RowDataBound" >
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="PackagePrice" HeaderText="سعر العبوة" />
                                            <asp:BoundField DataField="NoOfPackages" HeaderText="عدد العبوات" />
                                            
                                            <asp:TemplateField HeaderText="إجراءت">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="uiLinkButtonDelete" runat="server" CommandArgument='<%# Eval("PurchaseOrderDetailID") %>'  CssClass="btn blue" CommandName="DeleteDetail" OnClientClick="return confirm('هل تريد حذف هذا السجل ؟');" ><i class='icon-remove'></i> حذف</asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                        ...
                        <div class="form-actions">
                            ...
                            <div style="float: right; margin-right: -180px;">
                                <asp:LinkButton ID="uiLinkButtonBack" runat="server" CssClass="btn blue" OnClick="uiLinkButtonBack_Click"><i class='icon-arrow-left'></i> عودة لأوامر التوريد</asp:LinkButton>
                            </div>
                            ...
                            <div style="float: right;margin-right:100px; ">
                                <asp:LinkButton ID="uiLinkButtonPrint" runat="server" CssClass="btn blue" OnClick="uiLinkButtonPrint_Click"><i class='icon-print'></i> طباعة أمر توريد</asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="span12">
                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <asp:LinkButton ID="uiLinkButtonAdd" runat="server" CssClass="btn blue" OnClick="uiLinkButtonAdd_Click"><i class='icon-plus'></i> إضافة أمر توريد</asp:LinkButton>
                        <div class="clearfix" style="height: 20px;">
                        </div>
                        <asp:GridView ID="uiGridViewOrders" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            CssClass="table table-striped table-bordered" 
                            onrowdatabound="uiGridViewOrders_RowDataBound">
                            <AlternatingRowStyle HorizontalAlign="Center" />
                            ...
                            <RowStyle HorizontalAlign="Center" />
                            <Columns>
                                <asp:BoundField DataField="PurchaseOrderNo" HeaderText="رقم الأمر" />
                                <asp:BoundField DataField="PurchaseOrderDate" HeaderText="التاريخ" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField DataField="SupplierName" HeaderText="العميل" />
                                <asp:CheckBoxField DataField="Confirmed" HeaderText="مؤكد" />
                                <asp:TemplateField HeaderText="إجراءات">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="uiLinkButtonEdit" runat="server" CommandArgument='<%# Eval("PurchaseOrderID") %>'
                                            CssClass="btn blue" CommandName="EditOrder"><i class='icon-edit'></i> تعديل</asp:LinkButton>&nbsp;
                                        <asp:LinkButton ID="uiLinkButtonDelete" runat="server" CommandArgument='<%# Eval("PurchaseOrderID") %>' 
