...
<asp:Label runat="server" ID="lblTitle" Text="تغيير كلمة المرور" Font-Bold="true" Font-Size="17px"></asp:Label>
    ...
    <table dir="rtl" style="font-size:14px" cellpadding="4px" cellspacing="4px">
        ...
        <tr>
            <td>
                <asp:Label runat="server" ID="lblOldPassword" Font-Bold="true" Text="كلمة المرور الحالية"></asp:Label>
            </td>
            <td>
                <asp:TextBox runat="server" ID="txtOldPassword" TextMode="Password"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ID="requiredOldPassword" ErrorMessage="*"
                    ForeColor="Red" Display="Dynamic" ControlToValidate="txtOldPassword"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
