...
namespace MHO.DAL
{
	public abstract class _DeadMedicalInfo : SqlClientEntity
	{
		...
		protected class Parameters
		{
			...
			public static SqlParameter AbortionDate
			{
				get
				{
					return new SqlParameter("@AbortionDate", SqlDbType.DateTime, 0);
				}
			}
			...
			public static SqlParameter CauseOfDeathB
			{
				get
				{
					return new SqlParameter("@CauseOfDeathB", SqlDbType.Char, 20);
				}
			}
			
			public static SqlParameter AbortionPlace
			{
				get
				{
					return new SqlParameter("@AbortionPlace", SqlDbType.NVarChar, 200);
				}
			}
		...
		public virtual DateTime AbortionDate
	    {
			get
	        {
				return base.GetDateTime(ColumnNames.AbortionDate);
			}
			set
	        {
				base.SetDateTime(ColumnNames.AbortionDate, value);
			}
		}

		public virtual string CauseOfDeathB
	    {
			get
	        {
				return base.Getstring(ColumnNames.CauseOfDeathB);
			}
			set
	        {
				base.Setstring(ColumnNames.CauseOfDeathB, value);
			}
		}

		public virtual string AbortionPlace
	    {
			get
	        {
				return base.Getstring(ColumnNames.AbortionPlace);
			}
			set
	        {
		...
		public virtual string s_AbortionDate
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.AbortionDate) ? string.Empty : base.GetDateTimeAsString(ColumnNames.AbortionDate);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.AbortionDate);
				else
					this.AbortionDate = base.SetDateTimeAsString(ColumnNames.AbortionDate, value);
			}
		}
		...
		public virtual string s_CauseOfDeathB
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.CauseOfDeathB) ? string.Empty : base.GetstringAsString(ColumnNames.CauseOfDeathB);
			}
			set
	        {
				if(string.Empty == value)
					...
					this.CauseOfDeathB = base.SetstringAsString(ColumnNames.CauseOfDeathB, value);
			}
		}

		public virtual string s_AbortionPlace
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.AbortionPlace) ? string.Empty : base.GetstringAsString(ColumnNames.AbortionPlace);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.AbortionPlace);
				else
					this.AbortionPlace = base.SetstringAsString(ColumnNames.AbortionPlace, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter AbortionDate
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.AbortionDate, Parameters.AbortionDate);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
				...
				public WhereParameter AbortionPlace
				{
					get
					{
			...
			public WhereParameter AbortionDate
		    {
				get
		        {
					if(_AbortionDate_W == null)
	        	    {
						_AbortionDate_W = TearOff.AbortionDate;
					}
					return _AbortionDate_W;
				}
			}
			...
			public WhereParameter AbortionPlace
		    {
				get
		        {
					if(_AbortionPlace_W == null)
	        	    {
						_AbortionPlace_W = TearOff.AbortionPlace;
					}
					return _AbortionPlace_W;
				}
			}
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter AbortionDate
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.AbortionDate, Parameters.AbortionDate);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
				...
				public AggregateParameter AbortionPlace
				{
					get
					{
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.AbortionDate);
			p.SourceColumn = ColumnNames.AbortionDate;
			p.SourceVersion = DataRowVersion.Current;
