...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="InnerContentWrapper" class="row">
        <div class="citer">
            <p>
        التسويق عبر البريد الإلكتروني هو شكل من أشكال التسويق المباشر، والذي يستخدم البريد الإلكتروني باعتباره وسائل التواصل التجاري. في أوسع معانيها، يمكن ارسال كمية من البريد الاكترونى الى عدد معين من العملاء ويمكن ان يكون العدد ضخم ويمكن جدولة تلك الايميلات  . 
