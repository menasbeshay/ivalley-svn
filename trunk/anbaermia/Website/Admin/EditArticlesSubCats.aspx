<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditArticlesSubCats.aspx.cs" Inherits="Website.Admin.EditArticlesSubCats" %>
    ...
    <div class="AdminMain" style="direction: rtl;">
        <asp:Panel ID="uiPanelViewCategories" runat="server">
            <div class="ContentLeftDiv">
                <h1>
                    الأقسام الفرعية لمكتبة المقالات
                </h1>
                <div class="Details675">
                    <div class="AdminRight">
                        <asp:Label ID="Label1" runat="server" Text="الصفحة :" CssClass="Label"></asp:Label>
                    </div>
                    <div class="AdminMiddle" style="width: 30%">
                        <asp:DropDownList ID="uiDropDownListPages" runat="server" OnSelectedIndexChanged="uiDropDownListPages_SelectedIndexChanged"
                    ...
                    <div class="AdminLeft">
                        <div class="AdminMore">
                            <asp:LinkButton ID="uiLinkButtonAdd" runat="server" OnClick="uiLinkButtonAdd_Click">إضافة قسم فرعى جديد</asp:LinkButton>
                        </div>
                    </div>
                    <div class="clear">
                    </div>
                    <div class="AdminMiddle" style="width: 100%">
                        <asp:GridView ID="uiGridViewSubCategories" runat="server" AutoGenerateColumns="false"
                            OnRowCommand="uiGridViewSubCategories_RowCommand" AllowPaging="True" HorizontalAlign="Center"
                            OnPageIndexChanging="uiGridViewSubCategories_PageIndexChanging" Width="80%">
                            <Columns>
