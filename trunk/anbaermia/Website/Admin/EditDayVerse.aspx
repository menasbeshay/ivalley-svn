<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditDayVerse.aspx.cs" Inherits="Website.Admin.EditDayVerse" %>
        ...
        <asp:Panel ID="uiPanelAllReadings" runat="server" Visible="true">
            <div class="ContentLeftDiv">
                ...
                <div class="Details675">
                    <div class="AdminMore">
                        <asp:LinkButton ID="uiLinkButtonAdd" runat="server" OnClick="uiLinkButtonAdd_Click">إضافة آية يوم </asp:LinkButton>
                    </div>
                    <div class="clear">
                    </div>
                    ...
                    <div class="AdminMiddle" style="text-align: center; width: 100%;">
                        <asp:GridView ID="uiGridViewVerse" runat="server" AutoGenerateColumns="False" CellPadding="1"
                            CellSpacing="3" OnRowCommand="uiGridViewVerse_RowCommand" AllowPaging="True"
                            OnPageIndexChanging="uiGridViewVerse_PageIndexChanging">
                            <AlternatingRowStyle HorizontalAlign="Center" />
                            <Columns>                                
                                <asp:TemplateField HeaderText="الآية">
                                    <ItemTemplate>
