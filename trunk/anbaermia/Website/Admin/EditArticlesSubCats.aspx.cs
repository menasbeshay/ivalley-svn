...
{
    public partial class EditArticlesSubCats : System.Web.UI.Page
    {
        #region properties
        public SubCategories CurrentSubCategory
        {
            get
            {
                if (Session["CurrentSubCategoryA"] != null)
                    return (SubCategories)Session["CurrentSubCategoryA"];
                else
                    return null;
            }
            set
            {
                Session["CurrentSubCategoryA"] = value;
            }
        }
        #endregion
