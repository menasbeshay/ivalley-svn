...
{
	public abstract class _GeneralVideos : SqlClientEntity
	{
		public _GeneralVideos()
		{
			this.QuerySource = "GeneralVideos";
			this.MappingName = "GeneralVideos";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_GeneralVideosLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int GeneralVideosID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.GeneralVideosID, GeneralVideosID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_GeneralVideosLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter GeneralVideosID
			{
				get
				{
					return new SqlParameter("@GeneralVideosID", SqlDbType.Int, 0);
				}
			}
		...
		{  
            public const string GeneralVideosID = "GeneralVideosID";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[GeneralVideosID] = _GeneralVideos.PropertyNames.GeneralVideosID;
					ht[EnTitle] = _GeneralVideos.PropertyNames.EnTitle;
					ht[ArTitle] = _GeneralVideos.PropertyNames.ArTitle;
					ht[SubCategoryID] = _GeneralVideos.PropertyNames.SubCategoryID;
					ht[URL] = _GeneralVideos.PropertyNames.URL;
					ht[Description] = _GeneralVideos.PropertyNames.Description;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[GeneralVideosID] = _GeneralVideos.ColumnNames.GeneralVideosID;
					ht[EnTitle] = _GeneralVideos.ColumnNames.EnTitle;
					ht[ArTitle] = _GeneralVideos.ColumnNames.ArTitle;
					ht[SubCategoryID] = _GeneralVideos.ColumnNames.SubCategoryID;
					ht[URL] = _GeneralVideos.ColumnNames.URL;
					ht[Description] = _GeneralVideos.ColumnNames.Description;
		...
		{  
            public const string GeneralVideosID = "s_GeneralVideosID";
		...
		public virtual int GeneralVideosID
	    {
			get
	        {
				return base.Getint(ColumnNames.GeneralVideosID);
			}
			set
	        {
				base.Setint(ColumnNames.GeneralVideosID, value);
			}
		}
		...
		public virtual string s_GeneralVideosID
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.GeneralVideosID) ? string.Empty : base.GetintAsString(ColumnNames.GeneralVideosID);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.GeneralVideosID);
				else
					this.GeneralVideosID = base.SetintAsString(ColumnNames.GeneralVideosID, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter GeneralVideosID
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.GeneralVideosID, Parameters.GeneralVideosID);
			...
			public WhereParameter GeneralVideosID
		    {
				get
		        {
					if(_GeneralVideosID_W == null)
	        	    {
						_GeneralVideosID_W = TearOff.GeneralVideosID;
					}
					return _GeneralVideosID_W;
				}
			}
			...
			private WhereParameter _GeneralVideosID_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter GeneralVideosID
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.GeneralVideosID, Parameters.GeneralVideosID);
			...
			private AggregateParameter _GeneralVideosID_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_GeneralVideosInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.GeneralVideosID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_GeneralVideosUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_GeneralVideosDelete]";
	
			SqlParameter p;
			p = cmd.Parameters.Add(Parameters.GeneralVideosID);
			p.SourceColumn = ColumnNames.GeneralVideosID;
