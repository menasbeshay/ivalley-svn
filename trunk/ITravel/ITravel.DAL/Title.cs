...
{
	public abstract class _Title : SqlClientEntity
	{
		public _Title()
		{
			this.QuerySource = "Title";
			this.MappingName = "Title";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_TitleLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int TitleID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.TitleID, TitleID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_TitleLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter Name
			{
				get
				{
					return new SqlParameter("@Name", SqlDbType.NVarChar, 40);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[TitleID] = _Title.PropertyNames.TitleID;
					ht[Name] = _Title.PropertyNames.Name;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[TitleID] = _Title.ColumnNames.TitleID;
					ht[Name] = _Title.ColumnNames.Name;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TitleInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.TitleID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TitleUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TitleDelete]";
