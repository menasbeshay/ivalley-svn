		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[UpdatedBy] = _AirPort.PropertyNames.UpdatedBy;
					ht[CreatedDate] = _AirPort.PropertyNames.CreatedDate;
					ht[LastUpdatedDate] = _AirPort.PropertyNames.LastUpdatedDate;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[UpdatedBy] = _AirPort.ColumnNames.UpdatedBy;
					ht[CreatedDate] = _AirPort.ColumnNames.CreatedDate;
					ht[LastUpdatedDate] = _AirPort.ColumnNames.LastUpdatedDate;
