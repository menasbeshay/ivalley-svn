...
{
	public abstract class _Activities : SqlClientEntity
	{
		public _Activities()
		{
			this.QuerySource = "Activities";
			this.MappingName = "Activities";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ActivitiesLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ActivityID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ActivitiesLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter Name
			{
				get
				{
					return new SqlParameter("@Name", SqlDbType.NVarChar, 30);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ActivityID] = _Activities.PropertyNames.ActivityID;
					ht[Name] = _Activities.PropertyNames.Name;
					ht[ShortName] = _Activities.PropertyNames.ShortName;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ActivityID] = _Activities.ColumnNames.ActivityID;
					ht[Name] = _Activities.ColumnNames.Name;
					ht[ShortName] = _Activities.ColumnNames.ShortName;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ActivitiesInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ActivitiesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ActivitiesDelete]";
