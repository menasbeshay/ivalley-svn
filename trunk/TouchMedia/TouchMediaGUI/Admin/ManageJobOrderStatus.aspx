<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="ManageJobOrderStatus.aspx.cs" Inherits="TouchMediaGUI.Admin.ManageJobOrderStatus" %>
    ...
    <div class="row-fluid">
        <div class="span12">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="#"><i class="icon-exclamation-sign"></i>ادارة حالة طلب الشغل</a><span class="divider divider-last">&nbsp;</span>
                </li>
            </ul>
        </div>
    </div>
                        ...
                        <div class="span12">
                            <asp:Panel ID="panelStatusGrid" runat="server">
                                ...
                                <asp:GridView ID="GridViewStatus" OnRowCommand="GridViewStatus_RowCommand" HorizontalAlign="Center" CssClass="table table-striped table-bordered" AutoGenerateColumns="false" runat="server">
                                    <Columns>
                                        <asp:BoundField HeaderText="اسم الحالة انجليزى" DataField="JobOrderStatusName" />
                                        <asp:BoundField HeaderText="اسم الحالة عربى" DataField="JobOrderStatusNameAr" />
                                        <asp:TemplateField HeaderText="العمليات">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnEditStatus" CssClass="btn btn-primary" CommandName="editStatus" CommandArgument='<%# Eval("JobOrderStatusID") %>' runat="server"><i class="icon-pencil icon-white"></i> تعديل</asp:LinkButton>
                                                <asp:LinkButton ID="btnDeleteStatus" CssClass="btn btn-danger" OnClientClick="return confirm('Are you want to delete this user?');" CommandName="deleteStatus" CommandArgument='<%# Eval("JobOrderStatusID") %>' runat="server"><i class="icon-remove icon-white"></i> مسح</asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
