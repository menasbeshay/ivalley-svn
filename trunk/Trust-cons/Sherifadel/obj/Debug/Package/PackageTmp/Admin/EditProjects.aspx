<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="EditProjects.aspx.cs" Inherits="Sherifadel.Admin.EditProjects" %>
                ...
                <div class="AdminDetails728">
                    ...
                    <div class="AdminMiddle">
                        <FCKeditorV2:FCKeditor ID="uiFCKeditorDesc" runat="server" 
                            BasePath="~/modules/fckeditor/" ToolbarSet="Basic" Height="300px" 
                        ...
                        <div class="ContentLeftDiv">
                            ...
                            <div class="Details675">
                                ...
                                <div class="AdminMiddle" style="width: 100%">
                                    ...
                                    <br />
                                    <a href='<%# Eval("PicPath") %>' rel="lightbox[chiledranroom]"><img src='../Images.aspx?Inner=product&Image=<%# Eval("PicPath") %>' alt="4" width="165" height="100"></a> 
                                    </div>
                                    </ItemTemplate>
                                </asp:DataList>
                                </div>
