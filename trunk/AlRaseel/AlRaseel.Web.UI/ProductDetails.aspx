<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductDetails.aspx.cs" Inherits="Web.UI.ProductDetails" %>
...
<head runat="server">
    ...
    <%--    <script src="demo_files/_fancybox_plugin/jquery.fancybox-1.3.4.pack.js"></script>--%>
    <%--    <link rel="stylesheet" href="demo_files/_fancybox_plugin/jquery.fancybox-1.3.4.css" media="screen">--%>
...
<%--    <script src="js/jquery.min.js" type="text/javascript"></script>--%>
    ...
    <script type="text/javascript">
        ...
        //    $('#divAlbumImages').fancygallery({ navigation: 'pagination', albumSelection: 'thumbnails', thumbnailSelectionOptions: { layout: 'polaroid' }, showOnlyFirstThumbnail: true });

        //    //code for example two
        //    $('#two-fg').fancygallery({ albumSelection: 'thumbnails', lightbox: 'fancybox', allMediasSelector: 'Show All', navigation: 'dots' });
    ...
    <style>
        ...
        #contact-section .parallax-overlay {
            background: #7e2e30 !important;
        }

        .ha-header.ha-transparent {
            background-color: rgba(252, 251, 235, 0.6) !important;
        }
                ...
                <div class="ha-header-front">
                    ...
                    <nav id="navigation" class="grid-50 hide-on-tablet hide-on-mobile ">
                        <ul id="menu-main" class="menu" style="font-family: 'Droid Arabic Kufi'!important;">
                            ...
                            <li class=""><a href="Default.aspx#top" class="">الرئيسية</a></li>
                            <li class=" "><a href="Default.aspx#section-about-brooklyn" class="">عن الرسيل</a></li>
                            <li class="menu-item menu-item-type-post_type menu-item-object-page "><a href="Default.aspx#section-our-service" class="">المنتجات</a></li>
                            <li class="menu-item menu-item-type-post_type menu-item-object-page "><a href="Default.aspx#section-work" class="">الالوان </a></li>
                            <li class="contact-us menu-item menu-item-type-custom menu-item-object-custom "><a href="Default.aspx#section-contact" class="">اتصل بنا</a></li>
                    ...
                    <nav id="ut-mobile-nav" class="ut-mobile-menu mobile-grid-100 tablet-grid-100 hide-on-desktop">
                        <div class="ut-scroll-pane">
                            <ul id="ut-mobile-menu" class="ut-mobile-menu" style="font-family: 'Droid Arabic Kufi'!important;">
                                ...
                                <li class="ut-home-link"><a href="Default.aspx#top" class="">الرئيسية</a></li>
                                <li class="menu-item menu-item-type-post_type menu-item-object-page "><a href="Default.aspx#section-about-brooklyn" class="">عن الرسيل</a></li>
                                <li class="menu-item menu-item-type-post_type menu-item-object-page "><a href="Default.aspx#section-our-service" class="">المنتجات</a></li>
                                <li class="menu-item menu-item-type-post_type menu-item-object-page "><a href="Default.aspx#section-work" class="">الالوان </a></li>
                                <li class="contact-us menu-item menu-item-type-custom menu-item-object-custom "><a href="Default.aspx#section-contact" class="">اتصل بنا</a></li>
        ...
        <footer class="footer ut-footer-dark">
            ...
            <div class="grid-container">
                <div class="grid-70 prefix-15 mobile-grid-100 tablet-grid-100 footer-content">
                    <%--<h3>We ss="fa fa-heart"></i>to design.</h3>--%>
        ...
        <script type="text/javascript">
            ...
            (function ($) {
                ...
                $(document).ready(function () {
                    ...
                    var $header = $("#header-section"), $logo = $(".site-logo img"), logo = $logo.attr("src"), logoalt = $logo.data("altlogo");
                    ...
                    //$(".parallax-banner").addClass("fixed").each(function () { $(this).parallax("50%", 0.6); });
                    $("section").each(function () {
                        var outerHeight = $(this).outerHeight(), offset = "90%", effect = $(this).data("effect");
                        if (outerHeight > $(window).height() / 2) {
                            offset = "70%";
                        } $(this).waypoint(function (direction) {
                            var $this = $(this);
                            if (direction === "down" && !$(this).hasClass(effect)) { $this.find(".section-content").animate({ opacity: 1 }, 1600); $this.find(".section-header-holder").animate({ opacity: 1 }, 1600); }
                        }, { offset: offset });
                    });
                });
            })(jQuery);
