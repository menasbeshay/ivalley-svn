...
<head runat="server">
    ...
    <!-- Title -->
    <title>Al Raseel | Flooring with unique concepts</title>
    <meta name="description" content="Al Raseel - Flooring with unique concepts">
                    ...
                    <div class="grid-30 tablet-grid-40 mobile-grid-40 ">
                        <div style="color: #7e2e30; font-size: 16px; font-weight: bold;">
                            ...
                            <div style="max-height: 30px; float: right;" class="">
                                <p><i class="fa fa-phone">011 1234 5678 </i></p>
                            </div>
                            <div style="max-height: 30px;" class="">
                                <p><i class="fa fa-envelope">info@al-raseel.com </i></p>
                            </div>
                    ...
                    <div class="hero-inner" style="text-align: center;">
                        ...
                        <div class="hth">
                            <h1 class="hero-title">
                                    ...
                                    (function ($) {
                                        ...
                                        var ut_word_rotator = function () {
                                            ...
                                            var ut_rotator_words = [
                                               '<span>Al Raseel</span> Flooring with unique concepts', '<span>Al Raseel</span> Flooring with unique concepts'
                                            ],
                                            counter = 0;
                                ...
                                <span id="ut_word_rotator_1" class=" ut-word-rotator" style="font-size: 45px;"><span>Al Raseel</span> Flooring with unique concepts</span>
                            </h1>
                        </div>
                ...
                <div class="grid-container section-header-holder">
                    ...
                    <div class="grid-70 prefix-15 mobile-grid-100 tablet-grid-100">
                        ...
                        <header class="section-header pt-style-2">
                            <h2 class="section-title"><span> About Al Raseel</span></h2>
                            <p class="lead"> .some data about Al Raseel here.some data about Al Raseel here.some data about Al Raseel heresome data about Al Raseel here.</p>
                        </header>
                    </div>
                    ...
                    <div class="grid-100 mobile-grid-100 tablet-grid-100">
                        ...
                        <div data-effect="fadeInLeft" class="ut-one-half democolor  ut-animate-element animated">
                            ...
                            <div class="ut-service-column" style="text-align: right;">
                                <h3>mission</h3>
                                <p>data about mission here .data about mission here .data about mission here .data about mission here .data about mission here . </p>
                            </div>
                        </div>
                        <div data-effect="fadeInRight" class="ut-one-half  ut-column-last ut-animate-element animated">
                            ...
                            <div class="ut-service-column">
                                <h3>vision</h3>
                                <p>data about vision here.data about vision here.data about vision here.data about vision here.data about vision here. </p>
                            </div>
                        </div>
                        <div style="text-align: center;">
                            <img alt="" class="ut-animate-image animated " data-effecttype="image" data-effect="fadeIn" src="../wp-content/uploads/2013/12/brooklyn-dark-31.png" />
                        </div>
                    ...
                    <div class="grid-100 mobile-grid-100 tablet-grid-100">
                        ...
                        <div class="ut-one-half ut-column-last  ">
                            <div data-effect="fadeInRight" class="clearfix democolor ut-column-last ut-animate-element animated">
                                ...
                                <div class="ut-service-column">
                                    <h3>title here</h3>
                                    <p>some data about here . some data about here . some data about here . some data about here . some data about here . </p>
                                </div>
                            </div>
                ...
                <div class="parallax-overlay parallax-overlay-pattern style_one">
                    ...
                    <div class="grid-container section-header-holder">
                        ...
                        <div class="grid-70 prefix-15 mobile-grid-100 tablet-grid-100">
                            ...
                            <header class="section-header pt-style-2">
                                <h2 class="section-title"><span>colours</span></h2>


                                <p class="lead">some data about colours here.some data about colours here.some data about colours here.some data about colours here.some data about colours here.some data about colours here.some data about colours here.some data about colours here.</p>
                ...
                <div class="grid-container parallax-content">
                    ...
                    <div class="grid-70 prefix-15 mobile-grid-100 tablet-grid-100">
                        <header class="parallax-header pt-style-2">
                            ...
                            <h2 class="parallax-title"><span>Al Raseel - Flooring with unique concepts</span></h2>
                        ...
                        <div class="contact-wrap">
                            ...
                            <div class="grid-70 prefix-15 mobile-grid-100 tablet-grid-100">
                                <div class="ut-left-footer-area clearfix" style="float:left; width:350px">
                                    ...
                                    <h2 style="text-align: center; direction: ltr">011 4564 8548</h2>
                                    <p style="text-align: center;">sunday–thursday | 10–5 </p>
                                    <h2 style="text-align: center;">Email Us  </h2>
                                    <p style="text-align: center;"><a href="../mailto:#">info@al-raseel.com</a></p>
                                    <h2 style="text-align: center;">Visit Us</h2>
                                    <p style="text-align: center;">address here</p>
