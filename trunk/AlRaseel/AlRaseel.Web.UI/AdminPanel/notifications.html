...
<body data-page="notifications">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-center">Notifications</div>
    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            <div class="page-title"> <i class="icon-custom-left"></i>
                <h3><strong>Original</strong> Notifications</h3>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Notifications</strong> options</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <h3><strong>Status</strong> variations</h3>
                                    <p>You have 3 types available: info, success and error.</p>
                                    <br>
                                    <button type="button" data-type="info" class="btn btn-info notification" data-message="<i class='fa fa-info-circle' style='color:#00A2D9;padding-right:8px'></i> You have successfully clicked on the notification button. Congratulation!" data-horiz-pos="right"
                                    data-verti-pos="bottom">Info</button>
                                    <button type="button" data-type="success" class="btn btn-success notification" data-message="<i class='fa fa-check-square-o' style='padding-right:6px'></i> You have successfully clicked on the notification button. Congratulation!" data-horiz-pos="right"
                                    data-verti-pos="bottom">Success</button>
                                    <button type="button" data-type="error" class="btn btn-danger notification" data-message="<i class='fa fa-frown-o' style='padding-right:6px'></i> Oops... Something went wrong. Hope we don\'t see me again." data-horiz-pos="right" data-verti-pos="bottom">Error</button>
                                </div>
                                <div class="col-md-4">
                                    <h3><strong>Positions</strong> options</h3>
                                    <p>You can adapt the horizontal and vertical position: top, bottom, left, right.</p>
                                    <br>
                                    <div class="notification_position">
                                        <div class="bit top left notification" data-type="success" data-message="<i class='fa fa-info-circle' style='color:#121212;padding-right:8px'></i> I am on  the top left" data-horiz-pos="left" data-verti-pos="top"></div>
                                        <div class="bit top right notification" data-type="info" data-message="<i class='fa fa-info-circle' style='color:#5DADE2;padding-right:8px'></i> I am on  the top right" data-horiz-pos="right" data-verti-pos="top"></div>
                                        <div class="bit top notification" data-type="info" data-message="<i class='fa fa-info-circle' style='color:#5DADE2;padding-right:8px'></i> I am on  the top center" data-horiz-pos="center" data-verti-pos="top"></div>
                                        <div class="bit medium left notification" data-type="success" data-message="<i class='fa fa-info-circle' style='color:#121212;padding-right:8px'></i> I am on  the middle left" data-horiz-pos="left" data-verti-pos="center"></div>
                                        <div class="bit medium right notification" data-type="info" data-message="<i class='fa fa-info-circle' style='color:#5DADE2;padding-right:8px'></i> I am on  the middle right" data-horiz-pos="right" data-verti-pos="center"></div>
                                        <div class="bit medium notification" data-type="info" data-message="<i class='fa fa-info-circle' style='color:#5DADE2;padding-right:8px'></i> I am on  the middle of the page" data-horiz-pos="center" data-verti-pos="center"></div>
                                        <div class="bit bottom left notification" data-type="success" data-message="<i class='fa fa-info-circle' style='color:#121212;padding-right:8px'></i> I am on  the bottom left" data-horiz-pos="left" data-verti-pos="bottom"></div>
                                        <div class="bit bottom right notification" data-type="info" data-message="<i class='fa fa-info-circle' style='color:#5DADE2;padding-right:8px'></i> I am on  the bottom right" data-horiz-pos="right" data-verti-pos="bottom"></div>
                                        <div class="bit bottom notification" data-type="info" data-message="<i class='fa fa-info-circle' style='color:#5DADE2;padding-right:8px'></i> I am on  the bottom center" data-horiz-pos="center" data-verti-pos="bottom"></div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="skin skin-minimal">
                                        <h3><strong>Many</strong> options</h3>
                                        <p>You can add an overlay, change animation, width...</p>
                                        <br>
                                        <button type="button" class="btn btn-dark notification" data-type="info" data-message="<i class='fa fa-info-circle' style='color:#5DADE2;padding-right:8px'></i> You can write what you want in Html here!" data-horiz-pos="right" data-verti-pos="bottom"
                                        data-overlay="true">With an overlay</button>
                                        <button type="button" class="btn btn-default notification" data-type="info" data-message="<h2>Welcome Home!</h2><p style='font-size:18px'>I am a large Notification</p><p>You can add image if you want." data-horiz-pos="center" data-verti-pos="center" data-min-width="600">I am large</button>
                                        <button type="button" id="notif-callback" class="btn btn-danger" data-type="info" data-message="<i class='fa fa-info-circle' style='color:#00A2D9;padding-right:8px'></i> You have successfully clicked on the notification button. Congratulation!" data-horiz-pos="right"
                                        data-verti-pos="bottom">With callback</button>
                                    </div>
                                </div>
                            </div>
                        </div>
