...
<body data-page="form_validation">
    <!-- BEGIN TOP MENU -->
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-center">Form Validation</div>
    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            <div class="page-title"> <i class="icon-custom-left"></i>
                <h3><strong>Validation</strong> of forms</h3>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Complete</strong> Validation</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <p>Validation form is very simple here. For example, to validate email, just add <code>parsley-type="email"</code> in your input.</p>
                                    <br>
                                    <form id="form1" class="form-horizontal" parsley-validate>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Name <span class="asterisk">*</span>
                                            </label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="url" name="url" class="form-control" parsley-type="url" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Phone Number</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" parsley-type="phone" placeholder="(XXX) XXXX XXX">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea rows="5" class="form-control valid" placeholder="Write your comment... (minimum 3 words)" parsley-minwords="3" required></textarea>
                                            </div>
                                        </div>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <p>You can validate many types of data: number of words, numbers, date format, after or before specific date, minimum or maximum number, if a word is in specific list, credit card numbers...</p>
                                    <br>
                                    <form id="form2" class="form-horizontal" parsley-validate>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Credit card Number <span class="asterisk">*</span>
                                            </label>
                                            <div class="col-sm-9">
                                                <input type="text" parsley-luhn="true" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Date <span class="asterisk">*</span>
                                            </label>
                                            <div class="col-sm-9">
                                                <input type="text" parsley-type="dateIso" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Number between 6 and 10</label>
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" parsley-rangelength="[6,10]" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Minimum 3 words</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" parsley-minwords="3">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Maximum 100 <span class="asterisk">*</span>
                                            </label>
                                            <div class="col-sm-9">
                                                <input type="number" max="100" class="form-control" parsley-luhn="true" placeholder="Number">
                                            </div>
                                        </div>
                                        <div class="col-sm-9 col-sm-offset-3">
                                            <div class="pull-right">
                                                <button class="btn btn-success" onclick="javascript:$('#form2').parsley('validate');">Validate</button>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Checkbox &amp; Radio</strong> input</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <p>Example of validation with checkbox and radio buttons.</p>
                                    <br>
                                    <div class="skin skin-flat">
                                        <div class="form-group">
                                            <div class="skin-section">
                                                <form id="form3" class="form-horizontal" parsley-validate>
                                                    <div class="form-group">
                                                        <label class="col-lg-4 control-label m-b-20"><strong>Your best quality</strong></label>
                                                        <div class="col-lg-8">
                                                            <div class="pos-rel h-40">
                                                                <input tabindex="13" type="checkbox" name="quality" parsley-mincheck="1" parsley-group="mygroup">
                                                                <label class="p-l-40" for="flat-checkbox-1">Honnest</label>
                                                            </div>
                                                            <div class="pos-rel h-40">
                                                                <input tabindex="13" type="checkbox" name="quality" parsley-mincheck="1" parsley-group="mygroup">
                                                                <label class="p-l-40" for="flat-checkbox-1">Courageous</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-lg-4 control-label m-b-20"><strong>Your sex</strong></label>
                                                        <div class="col-lg-8">
                                                            <div class="pos-rel">
                                                                <input tabindex="13" type="radio" name="sex" parsley-group="mygroup2" parsley-required="true" class="parsley-validated">
                                                                <label class="p-l-40" for="flat-checkbox-1">Male</label>
                                                            </div>
                                                            <div class="pos-rel">
                                                                <input tabindex="14" type="radio" name="sex" parsley-group="mygroup2" parsley-required="true" class="parsley-validated">
                                                ...
                                                <div class="col-sm-9 col-sm-offset-3">
                                                    <div>
                                                        <button class="btn btn-primary m-b-10" onclick="javascript:$('#form3').parsley('validate');">Submit</button>
                                                        <button type="reset" class="btn btn-default m-b-10">Cancel</button>
                                                    </div>
                                                </div>
                                            </div>
