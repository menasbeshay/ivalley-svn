...
<body data-page="image_croping">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-center">Images Croping</div>
    ...
    <div id="wrapper">
        ...
        <!-- BEGIN MAIN CONTENT -->
        <div id="main-content" class="image-croping">
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <h3><strong>Preview Pane</strong> Crop Image</h3>
                            <img src="assets/img/various/image_crop1.jpg" id="image_crop1" alt="[Jcrop Example]" />
                            <div id="preview-pane">
                                <div class="preview-container">
                                    <img src="assets/img/various/image_crop1.jpg" class="jcrop-preview" alt="Preview" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <h3><strong>Preview Pane</strong> Crop Image</h3>
                            <img src="assets/img/various/image_crop2.jpg" id="image_crop2" alt="[Jcrop Example]" />
                            <div id="style-button">
                                <div class="btn-group" id="buttonbar">
                                    <button id="radio1" data-setclass="jcrop-light" type="button" class="btn btn-default">Light</button>
                                    <button id="radio2" data-setclass="jcrop-dark" type="button" class="btn btn-dark">Dark</button>
                                    <button id="radio3" data-setclass="jcrop-normal" type="button" class="btn btn-warning active">Normal</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="assets/js/image_croping.js"></script>
