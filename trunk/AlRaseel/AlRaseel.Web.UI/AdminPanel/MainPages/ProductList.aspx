<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="ProductList.aspx.cs" Inherits="Web.UI.AdminPanel.MainPages.ProductList" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div style="float: right;">
                        <a class="btn btn-blue" href="~/AdminPanel/MainPages/ProductManagement.aspx" runat="server">AddNew...</a>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <asp:GridView ID="grdData" runat="server" CssClass="table table-bordered" AutoGenerateColumns="False" allowmultirowselection="True" OnRowCommand="grdData_RowCommand" OnRowDataBound="grdData_RowDataBound">
                                            <Columns>
                                                <asp:BoundField DataField="ProductTitle" HeaderText="Product Title" SortExpression="ProductTitle">
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HyperLink ID="imgEdit" runat="server" CssClass="grdimgicon" NavigateUrl='<%#"~/AdminPanel/MainPages/ProductManagement.aspx?ID="+Eval("Id")%>'
