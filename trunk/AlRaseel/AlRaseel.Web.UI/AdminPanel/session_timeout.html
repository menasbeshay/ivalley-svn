...
<body data-page="session_timeout">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-center">Session Timeout</div>
    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            <div class="page-title"> <i class="icon-custom-left"></i>
                <h3>Session Timeout <small> lockscreen after a moment</small></h3>
            </div>
            <div class="row">
                <div class="col-md-12">
    ...
    <script src="assets/plugins/idle-timeout/jquery.idletimer.js"></script>
    <script src="assets/plugins/idle-timeout/jquery.idletimeout.js"></script>
