<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="EditPages.aspx.cs" Inherits="archiplan.Admin.EditPages" %>
    ...
    <div class="AdminDiv">
        ...
        <asp:Panel ID="uiPanelCurrent" runat="server" Visible="false">
            ...
            <div class="smallrightHeight">
                <asp:TextBox ID="uiTextBoxTitle" runat="server" ValidationGroup="UpdateService"></asp:TextBox>
            </div>
            <div style="margin-left: 35px;">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required"
                    ControlToValidate="uiTextBoxTitle" ForeColor="#C76E1F" ValidationGroup="UpdateService"></asp:RequiredFieldValidator>
            </div>
            <div class="clear10">
            </div>
            ...
            <div class="smallrightHeight">
                <asp:TextBox ID="uiTextBoxTitle_en" runat="server" ValidationGroup="UpdateService"></asp:TextBox>
            </div>
            <div style="margin-left: 35px;">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required"
                    ControlToValidate="uiTextBoxTitle_en" ForeColor="#C76E1F" ValidationGroup="UpdateService"></asp:RequiredFieldValidator>
            </div>
            <div class="clear10">
            </div>
            ...
            <div style="float: left; width: 780px; height: 300px; padding-left: 20px;">
            ...
            <div style="float: left; width: 780px; height: 300px; padding-left: 20px;">
                <FCKeditorV2:FCKeditor ID="uiFCKeditorContent_en" runat="server" BasePath="~/modules/fckeditor/" Height="300px" SkinPath="skins/silver/">
                </FCKeditorV2:FCKeditor>
            </div>
