...
تستطيع أيضا وبالفيديو الإطلاع على بعض شهادات عملائنا وبدون اي تزييف لشهادات عملاء وهميين. </p>
                        <p id="port-text-caption"></p>
                         ...
                         <p id="testmon-text-caption1" class="testmon_txt">
                            <strong>الشركة السعودية للكهرباء . </strong>
                           الشركة السعودية للكهرباء في القطاع الغربي خاصةً استحدثنا فكرة جديدة هي عبارة عن مولدات متنقلة تخدم المشتركين في حالة الإنقطاعات الطارئة. هذه الفكرة الجديدة حبينا نبرزها سواء للعميل الداخلي أو الخارجي كمشتركين أو مسؤولين. فبحثنا عن شركة تبرز هذا الفكر الجديد، فوجدنا ضالتنا في صقر v. Studio استديو.  وأمانة أنا اتعاملت مع الشركة وكانت على درجة عالية من الإحترافية وانتجوا لنا منتج ممتاز عرضناه على المشتركين ولاقى استحساناً كبيراً.
                        </p>
                        <p id="testmon-text-caption2" class="testmon_txt">
                            <strong> جامعة الطائف . </strong>
نحن جامعة الطائف عملنا مع Sager V. Studio في المعرض والمؤتمر الدولي للتعليم العالي الخامس حيث قاموا بتصميم المتحدث الإفتراضي لنا ووحدة الهولوكونك. كنا سعداء جداً بالتعامل معهم، كنا محل كل عناية وتقدير كعملاء من الشركة. أبدوا إهتماماً كبيراً بالجناح وبمنتجات الجناح.. لهم منا كل التقدير والإحترام ولهم منا كل الشكر ونتمنى لهم التوفيق مستقبلاً.
                        </p>
                        <p id="testmon-text-caption3" class="testmon_txt">
                            <strong>شركة زان الحديثة </strong>
بسم الله الرحمن الرحيم نحن شركة زان الحديثة المحدودة، أكبر الشركات في مجال الأجهزة المسحية لما فكرنا نحن نعمل فيديو تعريفي عن الشركة بحثنا في الانترنت عن أفضل الشركات الموجودة وكان اختيارنا لشركة صقر في استديو وكان عندنا أمل أنهم يكونوا شركة كويسة نشتغل معهم ولما بدأنا نشتغل معهم وجدنا انهم اكثر من توقعاتنا وهذه كلمة أمينة أحب أقولها هم ناس محترمين يحافظوا على المواعيد وعندهم خبرة كويسة وعارفين هم بيعملوا ايه، وكمان عندهم دقة في إختيار الأمور وعملوا لنا ادفايس كويس جداً في كثير من الامور الخاصة بالفيدو واعتقد إن شاء الله نحنا نجحنا في اختيارنا وأشكرهم وإن شاء الله نتطلع نحن أي فيديو نطلعه في المستقبل إن شاء الله نحن نعمل مع بعض.  
                        </p>      
					</div>
				</div>
			</div>
