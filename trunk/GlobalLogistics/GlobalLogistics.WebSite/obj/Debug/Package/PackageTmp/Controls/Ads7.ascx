<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Ads7.ascx.cs" Inherits="GlobalLogistics.WebSite.Controls.Ads7" %>
...
<asp:Repeater ID="uiRepeaterEnAds" runat="server">
    ...
    <FooterTemplate>
     ...
     <asp:Image ID="DefEnImage" runat="server" ImageUrl="~/images/AdDef_7.gif" />
</asp:Panel>
...
<asp:Repeater ID="uiRepeaterArAds" runat="server">
    ...
    <asp:Image ID="DefArImage" runat="server" ImageUrl="~/Arabic/images/AdDef_7.gif" />
</asp:Panel>
