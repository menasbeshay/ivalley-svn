<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditAirLines.aspx.cs" Inherits="GlobalLogistics.WebSite.Administrator.EditAirLines" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
    $(function () {
        $("#mi22").addClass("selected");
    });
</script>
</asp:Content>
        ...
        <asp:Panel ID="uiPanelViewAds" runat="server">
            <div class="ContentLeftDiv">
                ...
                <div class="Details675">
                    ...
                    <div class="AdminMore">
                    <asp:LinkButton ID="uiLinkButtonAdd" runat="server" OnClick="uiLinkButtonAdd_Click">إضافة خط جوى جديد</asp:LinkButton>
                    </div>
                    <div class="clear10">
                    </div>
                    <div class="clear10">
                   ...
                   <div class="AdminRight" style="width: 160px" >
                    <asp:Label ID="Label3" runat="server" Text="رفع جداول خطوط جوية :" CssClass="Label"></asp:Label>
                       </div>
                    <div class="AdminMiddle" >
                        <asp:FileUpload ID="uiFileUploadAirLines" runat="server" />
                        &nbsp;<asp:RegularExpressionValidator ID="rexp" runat="server" 
                            ControlToValidate="uiFileUploadAirLines" Display="Dynamic" 
...
&nbsp;
                    ...
                    <div class="AdminMiddle" >
                        <asp:DropDownList ID="uiDropDownListCompanyUpload" runat="server" Width="250px">
                        </asp:DropDownList>
                    </div>
                    <div class="AdminLeft" >
                    </div>
                    ...
                    <asp:LinkButton ID="uiLinkButtonUpload" runat="server" 
                                OnClick="uiLinkButtonUpload_Click">رفع جداول خطوط جوية </asp:LinkButton>
                    </div>
                        </div>
                    <div class="AdminLeft">
                    ...
                    <div class="AdminMiddle" style="width:100%">
                        <asp:GridView ID="uiGridViewAirLines" runat="server" AutoGenerateColumns="false"
                            OnRowCommand="uiGridViewAirLines_RowCommand" AllowPaging="True" HorizontalAlign="Center"
                            OnPageIndexChanging="uiGridViewAirLines_PageIndexChanging" Width="80%" 
                            onrowdatabound="uiGridViewAirLines_RowDataBound">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="إجراءات">
                                    <ItemTemplate>                                        
                                        <asp:LinkButton ID="uiLinkButtonDelete" runat="server" CommandArgument='<%# Eval("AirLinesID") %>'
                                            CommandName="DeleteAirLine" OnClientClick="return confirm('Are you want to delete this record?');">حذف</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
