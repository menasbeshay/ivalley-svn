<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditAirPorts.aspx.cs" Inherits="GlobalLogistics.WebSite.Administrator.EditAirPorts" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
    $(function () {
        $("#mi24").addClass("selected");
    });
</script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="AdminMain" style="direction: rtl;">
        <asp:Panel ID="uiPanelViewAirPorts" runat="server">
            <div class="ContentLeftDiv">
                ...
                <div class="Details675">
                    <div class="AdminRight" style="width: 150px">
                     <div class="AdminMore">
                        <asp:LinkButton ID="uiLinkButtonAdd" runat="server" OnClick="uiLinkButtonAdd_Click">إضافة مطار جديد</asp:LinkButton>
                         </div>
                    </div>
            ...
            <div class="clear10">
                    ...
                    <div class="AdminMiddle" style="width:100%">
                        <asp:GridView ID="uiGridViewAirPorts" runat="server" AutoGenerateColumns="false"
                            OnRowCommand="uiGridViewAirPorts_RowCommand" AllowPaging="True" HorizontalAlign="Center"
                            OnPageIndexChanging="uiGridViewAirPorts_PageIndexChanging" Width="80%">
                            <Columns>
                                <asp:BoundField DataField="EnName" HeaderText="الإسم بالإنجليزية" />
                                <asp:BoundField DataField="ArName" HeaderText="الإسم بالعربية" />
                                <asp:BoundField DataField="AirPortCode" HeaderText="الكود" />
                                <asp:TemplateField HeaderText="إجراءات">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="uiLinkButtonEdit" runat="server" CommandArgument='<%# Eval("AirPortID") %>'
                                            CommandName="EditAirPort">تعديل</asp:LinkButton>&nbsp;
                                        <asp:LinkButton ID="uiLinkButtonDelete" runat="server" CommandArgument='<%# Eval("AirPortID") %>'
                                            CommandName="DeleteAirPort" OnClientClick="return confirm('Are you want to delete this record?');">حذف</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
