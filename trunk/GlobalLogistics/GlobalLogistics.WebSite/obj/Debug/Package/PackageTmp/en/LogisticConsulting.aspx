<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="LogisticConsulting.aspx.cs" Inherits="GlobalLogistics.WebSite.LogisticConsulting" %>
...
<div class="LeftContent" style="width: 120px">
                    ...
                    <div class="LeftContent" style="width: 120px">
                        <asp:Label ID="Label5" runat="server" Text="Your Inquiry :" CssClass="Label"></asp:Label></div>
                    <div class="MiddleContent">
