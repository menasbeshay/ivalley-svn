...
{
    public partial class LogisticConsulting : System.Web.UI.Page
    {
        ...
        protected void uiButtonUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                msg.Subject = " Logistic consulting inquiry request";
                msg.IsBodyHtml = true;
                ...
                msg.Body += "<br/> Inquiry : " + uiTextBoxQuery.Text;
                ...
                uiLabelMessage.Text = "your inquiry has been sent successfully.";
            }
            catch (Exception ex)
            {
                uiLabelMessage.Visible = true;
