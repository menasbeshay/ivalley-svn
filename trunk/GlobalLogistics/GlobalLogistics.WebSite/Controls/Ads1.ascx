<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Ads1.ascx.cs" Inherits="GlobalLogistics.WebSite.Controls.Ads1" %>
<asp:Panel ID="EnPanel" runat="server">
    ...
    <asp:Image ID="DefEnImage" runat="server" ImageUrl="~/images/AdDef_1.gif" />
</asp:Panel>
...
<asp:Panel ID="ArPanel" runat="server">
 ...
 <div id="Ad1" style="display:none">
    ...
    <FooterTemplate>
        ...
        <asp:Image ID="DefArImage" runat="server" ImageUrl="~/Arabic/images/AdDef_1.gif" />
</asp:Panel>
