<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Ads3.ascx.cs" Inherits="GlobalLogistics.WebSite.Controls.Ads3" %>
<asp:Panel ID="EnPanel" runat="server">
<asp:Repeater ID="uiRepeaterEnAds" runat="server">
    <HeaderTemplate>
    <div id="Ad3" style="height:175px;">
    </HeaderTemplate>
    <ItemTemplate>
   <a href='<%# Eval("URL") %>' target="_blank">
    ...
    <asp:Image ID="DefEnImage" runat="server" ImageUrl="~/images/AdDef_3.gif" style="margin-bottom:20px;" />
</asp:Panel>
...
<asp:Repeater ID="uiRepeaterArAds" runat="server">
    ...
    <div style="height:20px;">&nbsp;</div>
     ...
     <asp:Image ID="DefArImage" runat="server" ImageUrl="~/Arabic/images/AdDef_3.gif" style="margin-bottom:20px;" />
</asp:Panel>
