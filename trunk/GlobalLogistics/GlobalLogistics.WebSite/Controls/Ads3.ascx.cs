...
{
    public partial class Ads3 : System.Web.UI.UserControl
    {
        ...
        private void LoadLocationDefaults()
        {
            ...
            location1.LoadByPrimaryKey(3);
            uiLiteralScript.Text = "<script type=\"text/javascript\">$(document).ready(function () {$('#Ad3').cycle({ fx: 'fade' , timeout: " + location1.AdsTimeout.ToString() + " }); }); </script>";
        }

        private void BindArabicData()
        {
            BLL.Ads objData = new BLL.Ads();
            objData.GetAllAdsByLocation(3);
