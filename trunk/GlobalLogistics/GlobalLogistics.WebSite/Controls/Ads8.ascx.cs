...
{
    public partial class Ads8 : System.Web.UI.UserControl
    {
        ...
        private void LoadLocationDefaults()
        {
            ...
            location1.LoadByPrimaryKey(8);
            uiLiteralScript.Text = "<script type=\"text/javascript\">$(document).ready(function () {$('#Ad8').cycle({ fx: 'fade' , timeout: " + location1.AdsTimeout.ToString() + " }); }); </script>";
        }

        private void BindArabicData()
        {
            BLL.Ads objData = new BLL.Ads();
            objData.GetAllAdsByLocation(8);
