<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ARMaster.Master" AutoEventWireup="true" CodeBehind="CompanyProfile.aspx.cs" Inherits="GlobalLogistics.WebSite.Arabic.CompanyProfile" %>
...
<div class="ContentLeftDiv">
        ...
        <div class="Details675" style="padding-right:2px; padding-left: 2px;width:669px">
            <div id="CompanyTabs">
                <ul>
                    <li id="LIAbout" runat="server"><a href='<%= "#" + CompanyTabs_1.ClientID %>'>عن الشركة</a></li>
                    <li id="LIBranch" runat="server"><a href='<%= "#" + CompanyTabs_2.ClientID %>'>الفروع</a></li>
                    <li id="LIMap" runat="server"><a href='<%= "#" + CompanyTabs_3.ClientID %>'>الخريطة</a></li>
                    <li id="LIServices" runat="server"><a href='<%= "#" + CompanyTabs_4.ClientID %>'>الخدمات</a></li>
                    <li id="LIOffers" runat="server"><a href='<%= "#" + CompanyTabs_5.ClientID %>'>العروض</a></li>
                    <li id="LIRequests" runat="server"><a href='<%= "#" + CompanyTabs_6.ClientID %>'>الطلبات</a></li>
                    <li id="LIJobs" runat="server"><a href='<%= "#" + CompanyTabs_7.ClientID %>'>الوظائف</a></li>
                    <li id="LIPic" runat="server"><a href='<%= "#" + CompanyTabs_8.ClientID %>'>الصور</a></li>
                    <li id="LIVideos" runat="server"><a href='<%= "#" + CompanyTabs_9.ClientID %>'>الفيديو</a></li>
                    <li id="LISchedule" runat="server"><a href='<%= "#" + CompanyTabs_10.ClientID %>'>الجدول</a></li>
                    <li id="LIContacts" runat="server"><a href='<%= "#" + CompanyTabs_11.ClientID %>'>جهات الإتصال</a></li>
                    <li id="LIWebsite" runat="server"><a href='<%= "#" + CompanyTabs_12.ClientID %>'>الموقع</a></li>
                </ul>
