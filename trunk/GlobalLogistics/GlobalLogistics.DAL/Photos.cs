...
{
	public abstract class _Photos : SqlClientEntity
	{
		public _Photos()
		{
			this.QuerySource = "Photos";
			this.MappingName = "Photos";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PhotosLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int PhotoID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.PhotoID, PhotoID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PhotosLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter PhotoID
			{
				get
				{
					return new SqlParameter("@PhotoID", SqlDbType.Int, 0);
				}
			}
			...
			public static SqlParameter PhotoPath
			{
				get
				{
					return new SqlParameter("@PhotoPath", SqlDbType.NVarChar, 500);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[PhotoID] = _Photos.PropertyNames.PhotoID;
					ht[EnTitle] = _Photos.PropertyNames.EnTitle;
					ht[ArTitle] = _Photos.PropertyNames.ArTitle;
					ht[PhotoPath] = _Photos.PropertyNames.PhotoPath;
					ht[CategoryID] = _Photos.PropertyNames.CategoryID;
					ht[CreatedDate] = _Photos.PropertyNames.CreatedDate;
					ht[CompanyID] = _Photos.PropertyNames.CompanyID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[PhotoID] = _Photos.ColumnNames.PhotoID;
					ht[EnTitle] = _Photos.ColumnNames.EnTitle;
					ht[ArTitle] = _Photos.ColumnNames.ArTitle;
					ht[PhotoPath] = _Photos.ColumnNames.PhotoPath;
					ht[CategoryID] = _Photos.ColumnNames.CategoryID;
					ht[CreatedDate] = _Photos.ColumnNames.CreatedDate;
					ht[CompanyID] = _Photos.ColumnNames.CompanyID;
		...
		{  
            public const string PhotoID = "s_PhotoID";
		...
		public virtual int PhotoID
	    {
			get
	        {
				return base.Getint(ColumnNames.PhotoID);
			}
			set
	        {
				base.Setint(ColumnNames.PhotoID, value);
			}
		}
		...
		public virtual string s_PhotoID
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.PhotoID) ? string.Empty : base.GetintAsString(ColumnNames.PhotoID);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.PhotoID);
				else
					this.PhotoID = base.SetintAsString(ColumnNames.PhotoID, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter PhotoID
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.PhotoID, Parameters.PhotoID);
			...
			private WhereParameter _PhotoID_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter PhotoID
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.PhotoID, Parameters.PhotoID);
			...
			private AggregateParameter _PhotoID_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PhotosInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.PhotoID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PhotosUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PhotosDelete]";
	
			SqlParameter p;
			p = cmd.Parameters.Add(Parameters.PhotoID);
			p.SourceColumn = ColumnNames.PhotoID;
