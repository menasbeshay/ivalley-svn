...
{
	public abstract class _TicketType : SqlClientEntity
	{
		public _TicketType()
		{
			this.QuerySource = "TicketType";
			this.MappingName = "TicketType";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_TicketTypeLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int TicketTypeID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.TicketTypeID, TicketTypeID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_TicketTypeLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[TicketTypeID] = _TicketType.PropertyNames.TicketTypeID;
					ht[Name] = _TicketType.PropertyNames.Name;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[TicketTypeID] = _TicketType.ColumnNames.TicketTypeID;
					ht[Name] = _TicketType.ColumnNames.Name;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TicketTypeInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.TicketTypeID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TicketTypeUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TicketTypeDelete]";
