...
{
	public abstract class _Substances : SqlClientEntity
	{
		public _Substances()
		{
			this.QuerySource = "Substances";
			this.MappingName = "Substances";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_SubstancesLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_SubstancesLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Substances.PropertyNames.ID;
					ht[NAME] = _Substances.PropertyNames.NAME;
					ht[Approved] = _Substances.PropertyNames.Approved;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Substances.ColumnNames.ID;
					ht[NAME] = _Substances.ColumnNames.NAME;
					ht[Approved] = _Substances.ColumnNames.Approved;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SubstancesInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SubstancesUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SubstancesDelete]";
