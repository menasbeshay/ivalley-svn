<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="website.Admin.login" %>
            ...
            <td>
                <div class="btn">
                    <asp:LinkButton ID="uiLinkButtonLogin" runat="server" OnClick="uiLinkButtonLogin_Click"
                        ValidationGroup="Login" CssClass="mylink">Login</asp:LinkButton></div>
            </td>
            <td>
                &nbsp;
            </td>
