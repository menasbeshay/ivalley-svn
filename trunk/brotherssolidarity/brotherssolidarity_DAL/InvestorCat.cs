...
namespace DAL
{
	public abstract class _InvestorCat : SqlClientEntity
	{
		public _InvestorCat()
		{
			this.QuerySource = "InvestorCat";
			this.MappingName = "InvestorCat";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_InvestorCatLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int InvestorCatID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.InvestorCatID, InvestorCatID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_InvestorCatLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[InvestorCatID] = _InvestorCat.PropertyNames.InvestorCatID;
					ht[Name] = _InvestorCat.PropertyNames.Name;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[InvestorCatID] = _InvestorCat.ColumnNames.InvestorCatID;
					ht[Name] = _InvestorCat.ColumnNames.Name;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_InvestorCatInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.InvestorCatID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_InvestorCatUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_InvestorCatDelete]";
