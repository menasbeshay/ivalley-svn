<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Project.Master" AutoEventWireup="true" CodeBehind="projects.aspx.cs" Inherits="Sherifadel.projects" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <ItemTemplate>
                <div style="float: left; width: 22%; padding: 5px; margin: 5px;" >
                    <a href='Projects.aspx?pid=<%# Eval("ProductID") %>&cid=<%# Eval("CategoryID") %>'
                        ...
                        <span class="content_wight" style="font-weight:normal;"><%# Eval("ProductName") %></span>
                        <div class="clear5" ></div>
    ...
    <asp:Panel ID="uiPanelProductDetails" runat="server">
        ...
        <div style="width:40%;float:left;">
            ...
            <h3 style="margin:2px"><asp:Label ID="uiLabelProductName" runat="server" CssClass="content_wight" Font-Bold="true"></asp:Label></h3>
            <div style="text-align:left;padding-left:20px;font-size:14px;" class="content_wight">
