//tealium universal tag - utag.1 ut4.0.201211142258, Copyright 2012 Tealium.com Inc. All Rights Reserved.
var s_account="luxnewsunglasshutcom";var s=s_gi(s_account);s.dynamicAccountSelection=true;s.dynamicAccountList="luxsghqa=v7stage.sunglasshut.com;luxsghauqa=lcv7stage.com/au;luxsghauprod=sunglasshut.com/au";s.trackDownloadLinks=true;s.trackExternalLinks=true;s.trackInlineStats=true;s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls";s.linkInternalFilters="javascript:,sunglasshut.com,blog.sunglasshut.com,mauijim.sunglasshut.com,rules.sunglasshut.com,sghstage.sunglasshut.com";s.linkLeaveQueryString=false;s.linkTrackVars="None";s.linkTrackEvents="None";s.usePlugins=false;s.currencyCode="USD";s.visitorNamespace="luxottica";s.trackingServer="metrics.sunglasshut.com";s.trackingServerSecure="smetrics.sunglasshut.com";s.dc=122;var s_code='',s_objectID;function s_gi(un,pg,ss){var c="s.version='H.24.4';s.an=s_an;s.logDebug=function(m){var s=this,tcf=new Function('var e;try{console.log(\"'+s.rep(s.rep(m,\"\\n\",\"\\\\n\"),\""
...
try{(function(id,loader,u){try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};u.ev={'view':1,'link':1};u.o=s;u.map={"page_name":"pageName,prop11","page_name:Basket":"scView,scCheckout","qp.sid":"eVar16","qp.hhid":"eVar51","previous_page_name":"prop19","product_brand":"eVar3,prop12","product_name":"eVar32","customer_zip":"zip","customer_state":"state","page_type:Product":"prodView","order_id":"eVar27","search_keyword":"eVar1,event6","promo_code":"eVar9","store_locator":"event3,event13","order_payment_type":"eVar17","login_button:login":"event9","submit_button:submit":"event7","site_currency":"currencyCode","site_region":"prop14,eVar4","added_via_VTO":"eVar41"};u.extend=[function(a,b,c,d,e,f,g){d=b['dom.url'];if(typeof d=='undefined')return;c=[{'lcv7stage.com/au':'lux-sgh-au-qa'},{'lcv7stage.com/za':'luxsgh-rsa-qa'},{'lcv7stage.com/uk':'lux-sgh-uk-qa'},{'v7stage.sunglasshut.com/za':'luxsgh-rsa-qa'},{'v7stage.sunglasshut.com/uk':'lux-sgh-uk-qa'},{'http://v7stage.sunglasshut.com/au':'lux-sgh-au-qa'},{'v7stage.sunglasshut.com/':'luxsghqa'},{'sunglasshut.com/za':'luxsgh-rsa-production'},{'sunglasshut.com/uk':'lux-sgh-uk-production'},{'lcv7stage.com/us':'luxsghqa'},{'sunglasshut.com/au':'lux-sgh-au-prod'}];var m=false;for(e=0;e<c.length;e++){for(f in c[e]){if(d.indexOf(f)>-1){b['report_suite']=c[e][f];m=true};};if(m)break};if(!m)b['report_suite']='';},function(a,b){if(b.report_suite){u.o.dynamicAccountList=b.report_suite+"=.";}},function(a,b){if(typeof b['link']!='undefined'&&b['link']!=''){b['link_text']=b['link'];b['_cprod']=b['product']}},function(a,b){if(b._cprice&&b._cprice.length>0){for(var i=0;i<b._cprice.length;i++){b._cprice[i]=parseFloat(b._cprice[i].replace("$",""));b._cpdisc[i]=parseFloat(b._cpdisc[i].replace("-",""));b._cprice[i]=b._cprice[i]-b._cpdisc[i];b._cprice[i]=parseFloat(b._cprice[i]).toFixed(2);}}},function(a,b){s._channelDomain='Social Networks|facebook.com,flickr.com,twitter.com,youtube.com,myspace.com,linkedin.com,digg.com,delicious.com,reddit.com>';s._channelPattern='Paid Search|cpc>Email|ec>Banner|bnr>Affiliate|afk>Comparison Shopping Engine|cse>Placeholder 1|ph1>Placeholder 2|ph2>Placeholder 3|ph3';s.manageVars=new Function("c","l","f",""
...
+"Of('D=')!=0){s[t]=s[t].toLowerCase();}}");s.getAndPersistValue=new Function("v","c","e",""
+"var s=this,a=new Date;e=e?e:0;a.setTime(a.getTime()+e*86400000);if("
+"v)s.c_w(c,v,e?a:0);return s.c_r(c);");s.getQueryParam=new Function("p","d","u","h",""
...
+"==0?0:a);}return v==k?'':v");s.split=new Function("l","d",""
+"var i,x=0,a=new Array;while(l){i=l.indexOf(d);i=i>-1?i:l.length;a[x"
+"++]=l.substring(0,i);l=l.substring(i+d.length);}return a");s.apl=new Function("l","v","d","u",""
+"var s=this,m=0;if(!l)l='';if(u){var i,n,a=s.split(l,d);for(i=0;i<a."
+"length;i++){n=a[i];m=m||(u==1?(n==v):(n.toLowerCase()==v.toLowerCas"
+"e()));}}if(!m)l=l?l+d+v:v;return l");if(!s.__ccucr)
{s.c_rr=s.c_r;s.__ccucr=true;function c_r(k)
{var s=this,d=new Date,v=s.c_rr(k),c=s.c_rr('s_pers'),i,m,e;if(v)return v;k=s.ape(k);i=c.indexOf(' '+k+'=');c=i<0?s.c_rr('s_sess'):c;i=c.indexOf(' '+k+'=');m=i<0?i:c.indexOf('|',i);e=i<0?i:c.indexOf(';',i);m=m>0?m:e;v=i<0?'':s.epa(c.substring(i+2+k.length,m<0?c.length:m));if(m>0&&m!=e)if(parseInt(c.substring(m+1,e<0?c.length:e))<d.getTime())
{d.setTime(d.getTime()-60000);s.c_w(s.epa(k),'',d);v='';}return v;}
s.c_r=c_r;}
if(!s.__ccucw)
{s.c_wr=s.c_w;s.__ccucw=true;function c_w(k,v,e)
{var s=this,d=new Date,ht=0,pn='s_pers',sn='s_sess',pc=0,sc=0,pv,sv,c,i,t;d.setTime(d.getTime()-60000);if(s.c_rr(k))s.c_wr(k,'',d);k=s.ape(k);pv=s.c_rr(pn);i=pv.indexOf(' '+k+'=');if(i>-1)
{pv=pv.substring(0,i)+pv.substring(pv.indexOf(';',i)+1);pc=1;}sv=s.c_rr(sn);i=sv.indexOf(' '+k+'=');if(i>-1){sv=sv.substring(0,i)+sv.substring(sv.indexOf(';',i)+1);sc=1;}d=new Date;if(e){if(e.getTime()>d.getTime()){pv+=' '+k+'='+s.ape(v)+'|'+e.getTime()+';';pc=1;}}else{if(String(v).indexOf('%00')>-1){v=s.repl(v,'%00','');}sv+=' '+k+'='+s.ape(v)+';';sc=1;}if(sc)s.c_wr(sn,sv,0);if(pc){t=pv;while(t&&t.indexOf(';')!=-1){var t1=parseInt(t.substring(t.indexOf('|')+1,t.indexOf(';')));t=t.substring(t.indexOf(';')+1);ht=ht<t1?t1:ht;}d.setTime(ht);s.c_wr(pn,pv,d);}
...
+"se str+=w+v[x]+w;if(x<v.length-1)str+=d;}return f+str+b;");s.getTimeToComplete=new Function("v","cn","e",""
...
+"onds';}v=v*r/u;return (Math.round(v)/r)+' '+un;}}return '';");s.setupDynamicObjectIDs=new Function(""
...
+"s.c_w(c,v,t):s.c_w(c,'no value',t);return r}");s.p_fo=new Function("n",""
+"var s=this;if(!s.__fo){s.__fo=new Object;}if(!s.__fo[n]){s.__fo[n]="
+"new Object;return 1;}else {return 0;}");s.channelManager=new Function("a","b","c","d","e","f",""
...
+"h";s.getTimeParting=new Function("t","z","y","l",""
...
+"eturn A}}else{return Z+', '+W}}}");s.handlePPVevents=new Function("",""
...
+")?(a):(a[1]);");s.getVisitStart=new Function("c",""
+"var s=this,v=1,t=new Date;t.setTime(t.getTime()+1800000);if(s.c_r(c"
+")){v=0}if(!s.c_w(c,1,t)){s.c_w(c,1,0)}if(!s.c_r(c)){v=0}return v;");s.clickPast=new Function("scp","ct_ev","cp_ev","cpc",""
+"var s=this,scp,ct_ev,cp_ev,cpc,ev,tct;if(s.p_fo(ct_ev)==1){if(!cpc)"
+"{cpc='s_cpc';}ev=s.events?s.events+',':'';if(scp){s.events=ev+ct_ev"
+";s.c_w(cpc,1,0);}else{if(s.c_r(cpc)>=1){s.events=ev+cp_ev;s.c_w(cpc"
+",0,0);}}}");},function(a,b){s.prop19=s.getPreviousValue(s.pageName,'gpv','');s.visitstart=s.getVisitStart('s_vs');if(s.visitstart&&s.visitstart==1){s.firstPage='firstpage';}
s.clickPast(s.firstPage,'event18','event19');s.campaign=s.getQueryParam('cid');s.eVar7=s.crossVisitParticipation(s.campaign,'s_cvp','30','5','>','purchase',0);if(s.campaign){s.eVar2="External Campaign";}
s.channelManager('cid','','','','cm_dl');s.eVar5=s.eVar35=s._channel;s.eVar33=s._campaign;s.eVar6=s.crossVisitParticipation(s.eVar5,'s_cvp','30','5','>','purchase',0);s.prop15=s.getPercentPageViewed();s.prop16=s.eVar8=s.getNewRepeat();if(!s.eVar2){s.eVar2='non-browse';}
if(!s.eVar30&&s.prop3!='pdp'){s.eVar30='Non-Browse';}
s.prop25=s.prop19;s.eVar25=s.prop19;s.campaign=s.getQueryParam('key,cid',':');},function(a,b){if(typeof utag.linkHandlerSU=='undefined'){utag.linkHandlerSU=function(a,b,c,d,e){if(!a){a=window.event;}
if(a.target){b=a.target;}else if(a.srcElement){b=a.srcElement;}
if(typeof b=="undefined"||typeof b.tagName=="undefined"){return;}
if(b.id=="go-sid"||b.id=="go-signup"){s.events="event12";s.linkTrackEvents="event12";s.tl();}}
utag.loader.EV(window,"mousedown",utag.linkHandlerSU);}},function(a,b){if(typeof utag.linkHandler=='undefined'){utag.linkHandler=function(a,b,c,d,e){if(!a){a=window.event;}
if(a.target){b=a.target;}
else if(a.srcElement){b=a.srcElement;}
if(typeof b=="undefined"||typeof b.tagName=="undefined"){return;}
if(typeof b.parentElement!="undefined"&&b.parentElement&&typeof b.parentElement.id!="undefined"&&b.parentElement.id.indexOf("WC_AccountDisplay_links_2")>-1){u.o.linkTrackVars="events";u.o.linkTrackEvents="event9";u.o.events="event9";u.o.tl(true,'o',"Log in Button");}
else if(typeof b.parentElement!="undefined"&&b.parentElement&&typeof b.parentElement.id!="undefined"&&b.parentElement.id.indexOf("WC_UserRegistrationAddForm_links_1")>-1){u.o.linkTrackVars="events";u.o.linkTrackEvents="event7";u.o.events="event7";u.o.tl(true,'o',"User Registration");}}}
utag.loader.EV(window,"mousedown",utag.linkHandler);}];u.send=function(a,b,c,d,e,f,g,h,ev,evt){if(u.ev[a]||typeof u.ev.all!="undefined"){for(c=0;c<u.extend.length;c++){try{d=u.extend[c](a,b);if(d==false)return}catch(e){}};if(typeof b._cprod!="undefined"&&b._cprod!=""){c=[];d={};ev={};for(e in utag.loader.GV(u.map)){if(typeof b[e]!="undefined"&&typeof u.map[e]=="string"&&u.map[e].indexOf("PRODUCTS_")>-1){f=u.map[e].split(",");for(g=0;g<f.length;g++){if(f[g].indexOf("PRODUCTS_evar")==0){d[f[g].substring(9)]=b[e].split(",");}else if(f[g].indexOf("PRODUCTS_event")==0){ev[f[g].substring(9)]=b[e]}}}}
...
u.o.products=c.join(",");}
b.sc_events=b.sc_events||{};evt=/^event|prodView|scOpen|scAdd|scRemove|scView|scCheckout|purchase$/;for(c in utag.loader.GV(b)){d=[];if(typeof u.map[c+":"+b[c]]!="undefined"){b[c+":"+b[c]]=b[c];d=u.map[c+":"+b[c]].split(",");}else if(typeof u.map[c]!="undefined")d=u.map[c].split(",");for(e=0;e<d.length;e++){if(d[e]!="events"&&evt.test(d[e])&&b[c]!=""){if(d[e].indexOf("ONCE_")==0){f=d[e].substring(5);if(utag.handler.ONCE("ev_"+b[c])){b.sc_events[f]=1;}}else b.sc_events[d[e]]=1;}}}
for(c in utag.loader.GV(b)){if(typeof u.map[c]!="undefined"){d=u.map[c].split(",");for(e=0;e<d.length;e++){if(d[e].indexOf("ONCE_")==0){f=d[e].substring(5);if(utag.loader.ONCE("map_"+b[c])){u.o[f]=b[c];}}else u.o[d[e]]=b[c]}}}
d=[];for(c in utag.loader.GV(b.sc_events)){if(b.sc_events[c])d.push(c)};if(d.length>0){u.o.events=d.join(",")};if(b._corder){u.o.purchaseID=((u.o.purchaseID)?u.o.purchaseID:b._corder);u.o.events=((u.o.events)?u.o.events:"purchase");if(u.o.events.indexOf("purchase")<0){u.o.events+=",purchase"};}
...
{if(typeof l[t[d]]=='undefined')l[t[d]]=c[d];else t[d]='D='+l[t[d]];}}}}catch(e){};u.o.t();utag.loader.SC("utag_main",{prevpage:(b.prevpage?b.prevpage:b["dom.title"])});}else if(a=="link"){if(typeof b.linkTrackVars=="undefined"&&b.event_name&&b.link_type){var v=[];b.linkTrackVars='';if(u.map["event_name:"+b.link_type]){v.push("events");u.o.events=b.linkTrackEvents=u.map["event_name:"+b.link_type];};if(u.map["link_type"]){v.push(u.map["link_type"])};if(u.map["link_text"]){v.push(u.map["link_text"])};if(u.map["link_url"]){v.push(u.map["link_url"])};b.linkTrackVars=v.join(',');}
u.o.linkTrackVars=(b.linkTrackVars)?b.linkTrackVars:"None";u.o.linkTrackEvents=(b.linkTrackEvents)?b.linkTrackEvents:"None";if(!u.o.linkType)u.o.linkType='o';if(b.link_name)b.link_text=b.link_name;b.link_text=(b.link_text)?b.link_text:"no link_name";if(b.link_type=='exit link'){u.o.linkType='e'}
else if(b.link_type=='download link')u.o.linkType='d';u.o.tl(((b.link_obj)?b.link_obj:true),u.o.linkType,b.link_text);}}};try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('1','luxottica.sunglasshut');}catch(e){};