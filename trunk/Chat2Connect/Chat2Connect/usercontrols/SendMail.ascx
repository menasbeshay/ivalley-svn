...
<div class="form-horizontal blockBox">
    <div class="col-sm-11 ">
        ...
        <div class="col-sm-8 pull-right">
            <asp:TextBox ID="txtFrom" runat="server" Enabled="false" CssClass="form-control" ClientIDMode="Static" TabIndex="0"></asp:TextBox>
        </div>
    ...
    <div class="col-sm-11">
        ...
        <div class="col-sm-8 pull-right">
            <asp:TextBox ID="txtTo" runat="server" CssClass="form-control" ClientIDMode="Static" TabIndex="1"></asp:TextBox>
        </div>
    ...
    <div class="col-sm-11">
        ...
        <div class="col-sm-8 pull-right">
            ...
            <textarea id="txtBody" class="form-control" style="height: 300px; padding: 0 !important;" tabindex="3">
            </textarea>
        </div>
    </div>
...
<asp:HiddenField ID="ltrBody" runat="server"></asp:HiddenField>
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        <% if (!String.IsNullOrEmpty(ToMemberName))
           {%>
        $('#txtTo').tokenInput('add', { id: <%= this.ToMemberID%>, name: '<%=this.ToMemberName%>' });
        Msgeditor.on("load", function() {
            Msgeditor.focus();
            Msgeditor.composer.commands.exec("insertHTML", "<br/><br/>------------------------------------------------<br/><br/>");
            Msgeditor.composer.commands.exec("insertHTML", $("#<%=ltrBody.ClientID%>").val());
