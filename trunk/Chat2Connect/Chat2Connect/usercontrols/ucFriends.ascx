    ...
    <div class="panel-group" id="accordion1">
        <div>
            ...
            <div id="helpcontact" class="panel-collapse collapse in" style="font-weight: bold;">
                ...
                <div class="Altodd">
                    <a href="#" data-bind="click:$root.openWindow.bind($data,$data.ID(),$data.Name(),'Private', false, false, 1, false,true)">
                            ...
                            <div class="popup-menu profileMenu" data-for='usernode-<%# Eval("MemberID") %>'>
                                ...
                                <div class="col-lg-9 pull-right">
                                    <div class="col-lg-6 pull-right">
                                        <ul>
                                            <li><a class="jslink" onclick='addChatRoom(<%# Eval("MemberID") %>, "<%# Eval("UserName") %>", "Private", false, false, 1, true);'><span class="awesome">&#xf0e6;</span> محادثة خاصة</a></li>
