<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="HomeV2.aspx.cs" Inherits="Chat2Connect.HomeV2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="js/chatWindowEvents.js"></script>
    <script>
        $(document).ready(function () {
