...
namespace DAL
{
	public abstract class _FriendGroup : SqlClientEntity
	{
		public _FriendGroup()
		{
			this.QuerySource = "FriendGroup";
			this.MappingName = "FriendGroup";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_FriendGroupLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int FriendGroupID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.FriendGroupID, FriendGroupID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_FriendGroupLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[FriendGroupID] = _FriendGroup.PropertyNames.FriendGroupID;
					ht[MemberID] = _FriendGroup.PropertyNames.MemberID;
					ht[Name] = _FriendGroup.PropertyNames.Name;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[FriendGroupID] = _FriendGroup.ColumnNames.FriendGroupID;
					ht[MemberID] = _FriendGroup.ColumnNames.MemberID;
					ht[Name] = _FriendGroup.ColumnNames.Name;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FriendGroupInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.FriendGroupID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FriendGroupUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_FriendGroupDelete]";
