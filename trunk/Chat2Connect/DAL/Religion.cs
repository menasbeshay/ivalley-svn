...
namespace DAL
{
	public abstract class _Religion : SqlClientEntity
	{
		public _Religion()
		{
			this.QuerySource = "Religion";
			this.MappingName = "Religion";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ReligionLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int ReligionID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.ReligionID, ReligionID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ReligionLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ReligionID] = _Religion.PropertyNames.ReligionID;
					ht[Name] = _Religion.PropertyNames.Name;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ReligionID] = _Religion.ColumnNames.ReligionID;
					ht[Name] = _Religion.ColumnNames.Name;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ReligionInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.ReligionID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ReligionUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ReligionDelete]";
