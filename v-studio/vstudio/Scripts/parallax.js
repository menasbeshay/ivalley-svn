...
var parallaxPage = function(name, pageHtml){
	return{
		key: name,
		page : pageHtml,
		right  : function(callback){return this.transition({left:parallax.width,top:0,opacity: 1}  ,{left:-parallax.width,top:0,opacity: 0.3} ,callback);},
		left   : function(callback){return this.transition({left:-parallax.width,top:0,opacity: 1} ,{left:parallax.width,top:0, opacity: 0.3}  ,callback);},
