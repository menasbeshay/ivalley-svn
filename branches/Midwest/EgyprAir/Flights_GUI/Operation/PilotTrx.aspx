        ...
        <div class="Details900">
                ...
                <asp:Panel ID="uiPanelSearch" runat="server" DefaultButton="uiLinkButtonSearch">
                    <div class="span12 clearfix">
                        <div class="span2"><asp:Label ID="Label5" runat="server" Text="Select Pilot" CssClass="Label"></asp:Label></div>
                        <div class="span6"><asp:DropDownList ID="uiRadComboBoxPilotSearch" Runat="server" Width="250px" ></asp:DropDownList></div>
                        <div class="span4"></div>
                    </div>
                ...
                <telerik:RadGrid ID="uiRadGridTrx" runat="server" AllowPaging="True" 
                        ...
                        <Columns>
                        <telerik:GridBoundColumn DataField="DisplayName" HeaderText="Pilot" ></telerik:GridBoundColumn>                                                                                                
                        ...
                        <telerik:GridTemplateColumn HeaderText="Actions">
                                <ItemTemplate>                                                                    
                                     <asp:LinkButton ID="uiLinkButtonEdit" runat="server" CommandArgument='<%# Eval("PilotTransactionID").ToString() %>'
                                        CommandName="EditTrx" ><img src="../images/edit.png" alt="Edit" title="Edit" style="border:0;float:none;" /></asp:LinkButton>
                                    &nbsp;
                                    <asp:LinkButton ID="uiLinkButtonDelete" runat="server" CommandArgument='<%# Eval("PilotTransactionID").ToString() %>'
    ...
    <div class="ContentLeftDiv">
        ...
        <div class="Details900">
            <div class="AdminLeft" style="width: 120px">
                <asp:Label ID="Label1" runat="server" Text="Select Pilot" CssClass="Label"></asp:Label></div>
            <div class="AdminMiddle">
                <asp:DropDownList ID="uiRadComboBoxPilot" Runat="server" 
                    Width="250px" >
                </asp:DropDownList>
            </div>
            <div class="AdminRight">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="uiRadComboBoxPilot" Display="Dynamic" ErrorMessage="*" 
                    ForeColor="Red" ValidationGroup="Activities" InitialValue="Select pilot"></asp:RequiredFieldValidator>
            </div>
            <div class="clear5">
            </div>
            <div class="AdminLeft" style="width: 120px">
