<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Reports.aspx.cs" Inherits="Flights_GUI.Operation.Reports" %>
                ...
                <div class="AdminLeft" style="width: 10%">
                            ...
                            <div class="AdminMiddle" style="width: 100%">
                                ...
                                <rsweb:ReportViewer ID="ReportViewer2" runat="server" Width="100%" 
                                    ...
                                    <LocalReport ReportPath="Reports\PerDiem.rdlc">                                    
