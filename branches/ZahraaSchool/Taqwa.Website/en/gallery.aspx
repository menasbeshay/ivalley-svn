<%@ Page Title="" Language="C#" MasterPageFile="~/Zahraa.Master" AutoEventWireup="true" CodeBehind="gallery.aspx.cs" Inherits="Taqwa.Website.en.gallery" %>
...
<div class="col-lg-12 row">
        ...
        <ItemTemplate>        
                            <li><a href="#filter" data-option-value='.<%# Eval("displayname").ToString().Trim() %>'><%# Eval("EnTitle")%></a></li>                            
        </ItemTemplate>
        <FooterTemplate>
         </ul><!--end:filters-->
                    </div>
        ...
        <asp:Repeater ID="uiRepeaterPhotos" runat="server">
           ...
           <%-- <div id="Gallery">
            ...
            <li class='element <%# Eval("displayname") %>'>
                      <figure>
                          <img src='<%# Eval("PhotoPath") %>' alt='<%# Eval("EnTitle") %>' />
                          <figcaption>
                          <h3><a href="#"><%# Eval("EnTitle") %></a></h3>
                          <footer>
