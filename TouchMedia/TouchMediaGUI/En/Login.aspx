<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TouchMediaGUI.En.Login" %>
            ...
            <div id="loginform" class="form-vertical no-padding no-margin">
                ...
                <asp:Login ID="Login1" runat="server">
                    <LayoutTemplate>
                        ...
                        <asp:Button ID="LoginButton" runat="server" CommandName="Login" Text="Login" ValidationGroup="Login1" CssClass="btn btn-block login-btn" />
                    </LayoutTemplate>
                </asp:Login>
