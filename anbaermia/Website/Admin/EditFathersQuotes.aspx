<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditFathersQuotes.aspx.cs" Inherits="Website.Admin.EditFathersQuotes" %>
        ...
        <asp:Panel ID="uiPanelAllReadings" runat="server" Visible="true">
            <div class="ContentLeftDiv">
                ...
                <div class="Details675">
                    <div class="AdminMore">
                        <asp:LinkButton ID="uiLinkButtonAdd" runat="server" OnClick="uiLinkButtonAdd_Click">إضافة أقوال جديدة </asp:LinkButton>
                    </div>
                    <div class="clear">
                    </div>
                    ...
                    <div class="AdminMiddle" style="text-align: center; width: 100%;">
                        <asp:GridView ID="uiGridViewQuotes" runat="server" AutoGenerateColumns="False" CellPadding="1"
                            CellSpacing="3" OnRowCommand="uiGridViewQuotes_RowCommand" AllowPaging="True"
                            OnPageIndexChanging="uiGridViewQuotes_PageIndexChanging">
                            <AlternatingRowStyle HorizontalAlign="Center" />
                            <Columns>                                
                                <asp:TemplateField HeaderText="المقولة">
                                    <ItemTemplate>
