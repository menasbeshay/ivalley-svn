<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditFilesSubcats.aspx.cs" Inherits="Website.Admin.EditFilesSubcats" %>
    ...
    <div class="AdminMain" style="direction: rtl;">
        <asp:Panel ID="uiPanelViewCategories" runat="server">
            <div class="ContentLeftDiv">
                <h1>
                    الأقسام الفرعية لمكتبة الملفات
                </h1>
