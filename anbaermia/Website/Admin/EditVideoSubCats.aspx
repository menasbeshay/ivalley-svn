<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditVideoSubCats.aspx.cs" Inherits="Website.Admin.EditVideoSubCats" %>
    ...
    <div class="AdminMain" style="direction: rtl;">
        <asp:Panel ID="uiPanelViewCategories" runat="server">
            <div class="ContentLeftDiv">
                <h1>
                    الأقسام الفرعية لمكتبة الفيديو
                </h1>
