...
{
    public partial class EditVideoSubCats : System.Web.UI.Page
    {
        #region properties
        public SubCategories CurrentSubCategory
        {
            get
            {
                if (Session["CurrentSubCategoryV"] != null)
                    return (SubCategories)Session["CurrentSubCategoryV"];
                else
                    return null;
            }
            set
            {
                Session["CurrentSubCategoryV"] = value;
            }
        }
        #endregion
