<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditPhotos.aspx.cs" Inherits="Website.Admin.EditPhotos" %>
                        ...
                        <asp:GridView ID="uiGridViewSubCategories" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="إجراءات">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="uiLinkButtonEdit" runat="server" CommandArgument='<%# Eval("GeneralPhotosID") %>'
                                            CommandName="EditPhoto" >تعديل</asp:LinkButton>
                                        &nbsp;
                                        <asp:LinkButton ID="uiLinkButtonDelete" runat="server" CommandArgument='<%# Eval("GeneralPhotosID") %>'
                                            CommandName="DeletePhoto" OnClientClick="return confirm('Are you want to delete this record?');">حذف</asp:LinkButton>
        ...
        <asp:Panel ID="uiPanelEdit" runat="server">
            <div class="ContentLeftDiv">
                ...
                <div class="AdminDetails728">
                    ...
                    <div class="AdminRight" style="width: 120px">
                        <asp:Label ID="Label6" runat="server" Text="الصورة :" CssClass="Label"></asp:Label>
                    </div>
                    <div class="AdminMiddle">
                    ...
                    <div class="AdminLeft">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*"
                            ControlToValidate="uiFileUploadImage" Display="Dynamic" ValidationGroup="EditPage"></asp:RequiredFieldValidator>
                    </div>
                    <div class="clear5">
                    </div>
                    <div class="AdminRight" style="width: 120px">
