...
{
    public partial class EditArticleCats : System.Web.UI.Page
    {
        #region properties
        public Categories CurrentCategory
        {
            get
            {
                if (Session["CurrentACategory"] != null)
                    return (Categories)Session["CurrentACategory"];
                else
                    return null;
            }
            set
            {
                Session["CurrentACategory"] = value;
            }
        }
        #endregion
