...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <section class="col-md-12 col-left">
         ...
         Your application has been saved successfully . You have to go and Pay only 1500 USD in order to finalize submition for Edu Monterial as a registeration fees.
                 </div>
             </asp:Panel>
        <h4>
