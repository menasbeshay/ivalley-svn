<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AREduMaster.Master" AutoEventWireup="true" CodeBehind="myaccount.aspx.cs" Inherits="EduMontreal.ar.myaccount" %>
    ...
    <section class="form-horizontal">
        ...
        <div class="form-group last">					
         ...
         <div class="form-actions fluid">					
					<div class="col-md-3">						
                        <asp:LinkButton ID="uiLinkButtonSignUp" runat="server" CssClass="btn btn-primary" OnClick="uiLinkButtonSignUp_Click" ValidationGroup="signup">حفظ</asp:LinkButton>
					</div>                     
				</div>
            </div>
    </section>
