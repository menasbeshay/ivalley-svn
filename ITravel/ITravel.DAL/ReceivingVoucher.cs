...
{
	public abstract class _ReceivingVoucher : SqlClientEntity
	{
		public _ReceivingVoucher()
		{
			this.QuerySource = "ReceivingVoucher";
			this.MappingName = "ReceivingVoucher";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ReceivingVoucherLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int ReceivingVoucherID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.ReceivingVoucherID, ReceivingVoucherID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ReceivingVoucherLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter ReceivingVoucherID
			{
				get
				{
					return new SqlParameter("@ReceivingVoucherID", SqlDbType.Int, 0);
				}
			}
		...
		{  
            public const string ReceivingVoucherID = "ReceivingVoucherID";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ReceivingVoucherID] = _ReceivingVoucher.PropertyNames.ReceivingVoucherID;
					ht[VoucherNumber] = _ReceivingVoucher.PropertyNames.VoucherNumber;
					ht[Amount] = _ReceivingVoucher.PropertyNames.Amount;
					ht[PaidFor] = _ReceivingVoucher.PropertyNames.PaidFor;
					ht[PassengerId] = _ReceivingVoucher.PropertyNames.PassengerId;
					ht[IsCheque] = _ReceivingVoucher.PropertyNames.IsCheque;
					ht[BankName] = _ReceivingVoucher.PropertyNames.BankName;
					ht[ChuqueDate] = _ReceivingVoucher.PropertyNames.ChuqueDate;
					ht[Reason] = _ReceivingVoucher.PropertyNames.Reason;
					ht[VoucherDate] = _ReceivingVoucher.PropertyNames.VoucherDate;
					ht[CreatedBy] = _ReceivingVoucher.PropertyNames.CreatedBy;
					ht[LastUpdatedDate] = _ReceivingVoucher.PropertyNames.LastUpdatedDate;
					ht[LastUpdatedBy] = _ReceivingVoucher.PropertyNames.LastUpdatedBy;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ReceivingVoucherID] = _ReceivingVoucher.ColumnNames.ReceivingVoucherID;
					ht[VoucherNumber] = _ReceivingVoucher.ColumnNames.VoucherNumber;
					ht[Amount] = _ReceivingVoucher.ColumnNames.Amount;
					ht[PaidFor] = _ReceivingVoucher.ColumnNames.PaidFor;
					ht[PassengerId] = _ReceivingVoucher.ColumnNames.PassengerId;
					ht[IsCheque] = _ReceivingVoucher.ColumnNames.IsCheque;
					ht[BankName] = _ReceivingVoucher.ColumnNames.BankName;
					ht[ChuqueDate] = _ReceivingVoucher.ColumnNames.ChuqueDate;
					ht[Reason] = _ReceivingVoucher.ColumnNames.Reason;
					ht[VoucherDate] = _ReceivingVoucher.ColumnNames.VoucherDate;
					ht[CreatedBy] = _ReceivingVoucher.ColumnNames.CreatedBy;
					ht[LastUpdatedDate] = _ReceivingVoucher.ColumnNames.LastUpdatedDate;
					ht[LastUpdatedBy] = _ReceivingVoucher.ColumnNames.LastUpdatedBy;
		...
		{  
            public const string ReceivingVoucherID = "s_ReceivingVoucherID";
		...
		public virtual int ReceivingVoucherID
	    {
			get
	        {
				return base.Getint(ColumnNames.ReceivingVoucherID);
			}
			set
	        {
				base.Setint(ColumnNames.ReceivingVoucherID, value);
			}
		}
		...
		public virtual string s_ReceivingVoucherID
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.ReceivingVoucherID) ? string.Empty : base.GetintAsString(ColumnNames.ReceivingVoucherID);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.ReceivingVoucherID);
				else
					this.ReceivingVoucherID = base.SetintAsString(ColumnNames.ReceivingVoucherID, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter ReceivingVoucherID
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.ReceivingVoucherID, Parameters.ReceivingVoucherID);
			...
			public WhereParameter ReceivingVoucherID
		    {
				get
		        {
					if(_ReceivingVoucherID_W == null)
	        	    {
						_ReceivingVoucherID_W = TearOff.ReceivingVoucherID;
					}
					return _ReceivingVoucherID_W;
				}
			}
			...
			private WhereParameter _ReceivingVoucherID_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter ReceivingVoucherID
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.ReceivingVoucherID, Parameters.ReceivingVoucherID);
			...
			private AggregateParameter _ReceivingVoucherID_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ReceivingVoucherInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.ReceivingVoucherID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ReceivingVoucherUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ReceivingVoucherDelete]";
	
			SqlParameter p;
			p = cmd.Parameters.Add(Parameters.ReceivingVoucherID);
			p.SourceColumn = ColumnNames.ReceivingVoucherID;
